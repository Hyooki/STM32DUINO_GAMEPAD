...
PA2 , // |                                    |       |    |    |    |     |     |     |     |     |      |*TX   |      |      |*IN2 |+TIM5_CH3 +TIM9_CH1 *TIM2_CH3             |          |    |          |           
...
PA8 , // |USB_SOF [TP1]                       |       |    |    |*SCL|     |     |     |     |     |      |      |      |      |     |+TIM1_CH1                                 |          |+D1 |          |           
PA9 , // |USB_VBUS                            |       |    |    |    |     |     |     |     |     |*TX   |      |      |      |     |+TIM1_CH2                                 |          |*D2 |          |           
PA10, // |USB_ID                              |       |    |    |    |     |     |     |     |+MOSI|*RX   |      |      |      |     |+TIM1_CH3                                 |          |    |          |           
PA11, // |USB_DM                              |       |    |    |    |     |     |     |+MISO|     |      |      |      |+TX   |     |+TIM1_CH4                                 |*OTG_FS_DM|    |          |           
PA12, // |USB_DP                              |       |    |    |    |     |     |     |     |+MISO|      |      |      |+RX   |     |                                          |*OTG_FS_DP|    |          |           
PA13, // |TMS                                 |       |    |    |    |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |*JTMS-SWDIO
PA14, // |TCK                                 |       |    |    |    |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |*JTCK-SWCLK
...
PB6 , // |                                    |       |*SCL|    |    |     |     |     |     |     |+TX   |      |      |      |     |+TIM4_CH1                                 |          |+D0 |          |           
PB7 , // |LD2 [Blue]                          |       |*SDA|    |    |     |     |     |     |     |+RX   |      |      |      |     |+TIM4_CH2                                 |          |    |          |           
PB8 , // |                                    |       |+SCL|    |+SDA|     |     |     |     |+MOSI|      |      |      |      |     |+TIM10_CH1 +TIM4_CH3                      |          |*D4 |          |           
PB9 , // |                                    |       |+SDA|+SDA|    |     |     |     |     |     |      |      |      |      |     |+TIM11_CH1 +TIM4_CH4                      |          |*D5 |          |           
PB10, // |                                    |+SCL   |+SCL|+SCL|    |     |*SCK |     |     |     |      |      |*TX   |      |     |+TIM2_CH3                                 |          |*D7 |          |           
PB11, // |                                    |       |    |+SDA|    |     |     |     |     |     |      |      |+RX   |      |     |+TIM2_CH4                                 |          |    |          |           
PB12, // |                                    |       |    |    |    |     |     |*SCK |     |     |      |      |      |      |     |                                          |          |    |          |           
PB13, // |                                    |       |    |    |    |     |+SCK |     |+SCK |     |      |      |      |      |     |+TIM1_CH1N                                |          |    |          |           
PB14, // |LD3 [Red]                           |+SDA   |+SDA|    |    |     |+MISO|     |     |     |      |      |      |      |     |+TIM8_CH2N +TIM1_CH2N *TIM12_CH1          |          |*D6 |          |           
...
PC7 , // |                                    |+SDA   |+SDA|    |    |     |+SCK |     |     |     |      |      |      |*RX   |     |+TIM3_CH2 *TIM8_CH2                       |          |+D7 |          |           
...
PD14, // |                                    |+SCL   |+SCL|    |    |     |     |     |     |     |      |      |      |      |     |*TIM4_CH3                                 |          |    |          |           
PD15, // |                                    |+SDA   |+SDA|    |    |     |     |     |     |     |      |      |      |      |     |*TIM4_CH4                                 |          |    |          |           
PE0 , // |                                    |       |    |    |    |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PE1 , // |                                    |       |    |    |    |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PE2 , // |                                    |       |    |    |    |     |     |     |*SCK |*SCK |      |      |      |      |     |                                          |          |    |          |*TRACECLK  
PE3 , // |                                    |       |    |    |    |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |*TRACED0   
PE4 , // |                                    |       |    |    |    |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |*TRACED1   
...
PE10, // |                                    |       |    |    |    |     |     |     |     |     |      |      |      |      |     |+TIM1_CH2N                                |          |    |          |           
PE11, // |                                    |       |    |    |    |     |     |     |     |     |      |      |      |      |     |*TIM1_CH2                                 |          |    |          |           
PE12, // |                                    |       |    |    |    |     |     |     |+SCK |+SCK |      |      |      |      |     |+TIM1_CH3N                                |          |    |          |           
PE13, // |                                    |       |    |    |    |     |     |     |+MISO|+MISO|      |      |      |      |     |*TIM1_CH3                                 |          |    |          |           
PE14, // |                                    |       |    |    |    |     |     |     |+MOSI|+MOSI|      |      |      |      |     |*TIM1_CH4                                 |          |    |          |           
PE15, // |                                    |       |    |    |    |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PF0 , // |                                    |       |    |*SDA|    |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PF1 , // |                                    |       |    |*SCL|    |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PF2 , // |                                    |       |    |    |    |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
...
PF4 , // |                                    |       |    |    |    |     |     |     |     |     |      |      |      |      |     |*TIM5_CH2                                 |          |    |          |           
PF5 , // |                                    |       |    |    |    |     |     |     |     |     |      |      |      |      |     |*TIM5_CH3                                 |          |    |          |           
PF6 , // |                                    |       |    |    |    |     |     |     |     |     |      |      |      |      |     |*TIM10_CH1                                |          |    |          |+TRACED0   
PF7 , // |                                    |       |    |    |    |     |     |     |     |     |      |      |      |      |     |*TIM11_CH1                                |          |    |          |+TRACED1   
PF8 , // |                                    |       |    |    |    |     |     |     |     |     |      |      |      |      |     |*TIM13_CH1                                |          |    |          |           
PF9 , // |                                    |       |    |    |    |     |     |     |     |     |      |      |      |      |     |*TIM14_CH1                                |          |    |          |           
PF10, // |                                    |       |    |    |    |     |     |     |     |     |      |      |      |      |     |*TIM5_CH4                                 |          |    |          |           
PF11, // |                                    |       |    |    |    |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
