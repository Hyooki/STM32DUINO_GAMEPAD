...
PA0 , // |                    |    |    |    |     |     |      |      |*TX   |      |*TIM2_CH1                       |   |          |       
PA1 , // |                    |    |    |    |     |     |      |      |*RX   |      |*TIM2_CH2                       |   |          |       
PA2 , // |USART_TX            |    |    |    |     |     |      |*TX   |      |      |*TIM21_CH1 *TIM2_CH3            |   |          |       
PA3 , // |USART_RX            |    |    |    |     |     |      |*RX   |      |      |*TIM21_CH2 *TIM2_CH4            |   |          |       
PA4 , // |                    |    |    |    |     |     |      |      |      |      |                                |   |          |       
PA5 , // |LD2 [Green Led]     |    |    |    |*SCK |     |      |      |      |      |+TIM2_CH1                       |   |          |       
PA6 , // |                    |    |    |    |*MISO|     |      |      |      |      |*TIM3_CH1 *TIM22_CH1            |   |          |       
PA7 , // |                    |    |    |    |*MOSI|     |      |      |      |      |*TIM3_CH2 *TIM22_CH2            |   |          |       
PA8 , // |                    |    |    |+SCL|     |     |      |      |      |      |                                |   |          |       
PA9 , // |                    |*SCL|    |    |     |     |*TX   |      |      |      |                                |   |          |       
PA10, // |                    |*SDA|    |    |     |     |*RX   |      |      |      |                                |   |          |       
PA11, // |                    |    |    |    |+MISO|     |      |      |      |      |                                |*DM|          |       
...
PB2 , // |                    |    |    |    |     |     |      |      |      |      |                                |   |          |       
PB3 , // |                    |    |    |    |+SCK |     |      |      |      |+TX   |+TIM2_CH2                       |   |          |       
PB4 , // |                    |    |    |+SDA|+MISO|     |      |      |      |+RX   |+TIM3_CH1 +TIM22_CH1            |   |          |       
PB5 , // |                    |    |    |    |+MOSI|     |      |      |      |      |+TIM3_CH2 +TIM22_CH2 +LPTIM1_IN1|   |          |       
PB6 , // |                    |+SCL|    |    |     |     |+TX   |      |      |      |                                |   |          |       
