...
enum {
//*=default , +=alternate
//PIN    |BOARD LABEL|I2C1|SPI1 |USART1|USART2|ADC1 |TIM (PWM)                        |RCC     |SYS           
PA0 , // |           |    |     |      |      |*IN1 |*TIM2_CH1                        |        |              
PA1 , // |           |    |     |      |      |*IN2 |*TIM15_CH1N *TIM2_CH2            |        |              
PA2 , // |VCP_TX     |    |     |      |*TX   |*IN3 |*TIM2_CH3 *TIM15_CH1             |        |              
...
PA15, // |VCP_RX     |*SCL|     |      |+RX   |     |+TIM2_CH1                        |        |*JTDI         
