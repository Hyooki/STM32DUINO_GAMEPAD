...
PA0 , // |B1 [Blue PushButton]|    |    |     |     |     |      |      |      |+TIM5_CH1 *TIM2_CH1          |   |          |              
PA1 , // |                    |    |    |     |     |     |      |      |      |+TIM5_CH2 *TIM2_CH2          |   |          |              
PA2 , // |                    |    |    |     |     |     |      |*TX   |      |+TIM5_CH3 *TIM9_CH1 *TIM2_CH3|   |          |              
PA3 , // |                    |    |    |     |     |     |      |*RX   |      |+TIM5_CH4 *TIM9_CH2 *TIM2_CH4|   |          |              
PA4 , // |                    |    |    |     |     |     |      |      |      |                             |   |          |              
PA5 , // |                    |    |    |*SCK |     |     |      |      |      |+TIM2_CH1                    |   |          |              
...
PC6 , // |                    |    |    |     |     |     |      |      |      |+TIM3_CH1                    |   |          |              
PC7 , // |                    |    |    |     |     |     |      |      |      |+TIM3_CH2                    |   |          |              
PC8 , // |LD4 [Blue Led]      |    |    |     |     |     |      |      |      |+TIM3_CH3                    |   |          |              
PC9 , // |LD3 [Green Led]     |    |    |     |     |     |      |      |      |+TIM3_CH4                    |   |          |              
PC10, // |                    |    |    |     |     |*SCK |      |      |+TX   |                             |   |          |              
PC11, // |                    |    |    |     |     |*MISO|      |      |+RX   |                             |   |          |              
PC12, // |                    |    |    |     |     |*MOSI|      |      |      |                             |   |          |              
PC13, // |                    |    |    |     |     |     |      |      |      |                             |   |          |              
