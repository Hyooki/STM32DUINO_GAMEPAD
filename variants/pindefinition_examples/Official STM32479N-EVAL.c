...
PA4 , // |Potentiometer [RV1]                      |    |    |    |     |     |     |     |     |     |      |      |      |      |*IN4 |                                          |          |    |          |           
PA5 , // |ULPI_CK [USB3300-EZK_CLKOUT]             |    |    |    |+SCK |     |     |     |     |     |      |      |      |      |*IN5 |+TIM8_CH1N +TIM2_CH1                      |          |    |          |           
PA6 , // |                                         |    |    |    |+MISO|     |     |     |     |     |      |      |      |      |*IN6 |+TIM3_CH1 +TIM13_CH1                      |          |    |          |           
PA7 , // |MII_RX_DV [DP83848CVV_RX_DV]             |    |    |    |+MOSI|     |     |     |     |     |      |      |      |      |*IN7 |+TIM8_CH1N +TIM14_CH1 +TIM3_CH2 +TIM1_CH1N|          |    |          |           
PA8 , // |LCD_BL_CTRL                              |    |    |*SCL|     |     |     |     |     |     |      |      |      |      |     |*TIM1_CH1                                 |          |    |          |           
...
PB7 , // |PAR_VSYNC                                |+SDA|    |    |     |     |     |     |     |     |*RX   |      |      |      |     |*TIM4_CH2                                 |          |    |          |           
PB8 , // |I2C1_SCL [WM8994ECS/R_SLCK]              |*SCL|    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM10_CH1 *TIM4_CH3                      |          |*D4 |          |           
PB9 , // |I2C1_SDA [WM8994ECS/R_SDA]               |*SDA|    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM11_CH1 *TIM4_CH4                      |          |*D5 |          |           
...
PC1 , // |MII_MDC [DP83848CVV_MDC]                 |    |    |    |     |+MOSI|     |     |     |     |      |      |      |      |*IN11|                                          |          |    |          |+TRACED0   
...
PC6 , // |I2S3_CK                                  |    |    |    |     |     |     |     |     |     |      |      |      |+TX   |     |+TIM8_CH1 +TIM3_CH1                       |          |*D6 |          |           
PC7 , // |MIK_CK                                   |    |    |    |     |     |     |     |     |     |      |      |      |+RX   |     |+TIM8_CH2 +TIM3_CH2                       |          |*D7 |          |           
...
PD3 , // |                                         |    |    |    |     |*SCK |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PD4 , // |FMC_NOE [CY7C1071DV33-12BAXI_OE]         |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PD5 , // |FMC_NOE [CY7C1071DV33-12BAXI_OE]         |    |    |    |     |     |     |     |     |     |      |*TX   |      |      |     |                                          |          |    |          |           
PD6 , // |FMC_NWAIT [S29GL128S90FHI02_RB]          |    |    |    |     |     |+MOSI|     |     |     |      |*RX   |      |      |     |                                          |          |    |          |           
PD7 , // |FMC_NE1 [S29GL128S90FHI02_E]             |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PD8 , // |D13                                      |    |    |    |     |     |     |     |     |     |      |      |+TX   |      |     |                                          |          |    |          |           
PD9 , // |D14                                      |    |    |    |     |     |     |     |     |     |      |      |+RX   |      |     |                                          |          |    |          |           
PD10, // |D15                                      |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PD11, // |A16                                      |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
...
PD14, // |D0                                       |    |    |    |     |     |     |     |     |     |      |      |      |      |     |+TIM4_CH3                                 |          |    |          |           
PD15, // |D1                                       |    |    |    |     |     |     |     |     |     |      |      |      |      |     |+TIM4_CH4                                 |          |    |          |           
PE0 , // |FMC_NBL0_CY7C1071DV33]                   |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PE1 , // |FMC_NBL1 [CY7C1071DV33_BHE]              |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PE2 , // |MII_TXD3                                 |    |    |    |     |     |     |*SCK |     |     |      |      |      |      |     |                                          |          |    |          |*TRACECLK  
PE3 , // |A19                                      |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |*TRACED0   
PE4 , // |A20                                      |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |*TRACED1   
PE5 , // |A21 [S29GL128S90FHI02_A21]               |    |    |    |     |     |     |*MISO|     |     |      |      |      |      |     |*TIM9_CH1                                 |          |    |          |*TRACED2   
PE6 , // |A22 [S29GL128S90FHI02_A22]               |    |    |    |     |     |     |*MOSI|     |     |      |      |      |      |     |*TIM9_CH2                                 |          |    |          |+TRACED3   
PE7 , // |D4                                       |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PE8 , // |D5                                       |    |    |    |     |     |     |     |     |     |      |      |      |      |     |+TIM1_CH1N                                |          |    |          |           
PE9 , // |D6                                       |    |    |    |     |     |     |     |     |     |      |      |      |      |     |+TIM1_CH1                                 |          |    |          |           
PE10, // |D7                                       |    |    |    |     |     |     |     |     |     |      |      |      |      |     |+TIM1_CH2N                                |          |    |          |           
...
PF4 , // |A4                                       |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PF5 , // |A5                                       |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PF6 , // |QSPI_BK1_IO3 [MT25QL512ABA8ESF-0SIT_DQ3] |    |    |    |     |     |     |     |     |     |      |      |      |      |     |+TIM10_CH1                                |          |    |          |           
PF7 , // |QSPI_BK1_IO2 [MT25QL512ABA8ESF-0SIT_DQ2] |    |    |    |     |     |     |     |*SCK |     |      |      |      |      |     |+TIM11_CH1                                |          |    |          |           
PF8 , // |QSPI_BK1_IO0 [MT25QL512ABA8ESF-0SIT_DQ0] |    |    |    |     |     |     |     |*MISO|     |      |      |      |      |     |*TIM13_CH1                                |          |    |          |           
PF9 , // |QSPI_BK1_IO1 [MT25QL512ABA8ESF-0SIT_DQ1] |    |    |    |     |     |     |     |*MOSI|     |      |      |      |      |     |*TIM14_CH1                                |          |    |          |           
PF10, // |QSPI_CLK [MT25QL512ABA8ESF-0SIT_CLK]     |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PF11, // |SDNRAS [MT48LC4M32B2B5-7_RAS]            |    |    |    |     |     |     |     |+MOSI|     |      |      |      |      |     |                                          |          |    |          |           
PF12, // |A6                                       |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PF13, // |A7                                       |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PF14, // |A8                                       |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PF15, // |A9                                       |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
...
PG8 , // |SDCLK [MT48LC4M32B2B5-7_CLK]             |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PG9 , // |FMC_NE2 [CY7C1071DV33-12BAXI_CE]         |    |    |    |     |     |     |     |     |     |      |      |      |*RX   |     |                                          |          |    |          |           
PG10, // |                                         |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PG11, // |MII_TX_EN [DP83848CVV_TXEN]              |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PG12, // |                                         |    |    |    |     |     |     |     |     |*MISO|      |      |      |      |     |                                          |          |    |          |           
PG13, // |MII_TXD0 [DP83848CVV_TXD_0]              |    |    |    |     |     |     |     |     |*SCK |      |      |      |      |     |                                          |          |    |          |+TRACED0   
PG14, // |MII_TXD1                                 |    |    |    |     |     |     |     |     |*MOSI|      |      |      |*TX   |     |                                          |          |    |          |+TRACED1   
PG15, // |SDNCAS [MT48LC4M32B2B5-7_CAS\#]          |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PH0 , // |OSC_IN                                   |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |*OSC_IN   |           
PH1 , // |OSC_OUT                                  |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |*OSC_OUT  |           
PH2 , // |SDCKE0 [MT48LC4M32B2B5-7_CKE]            |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PH3 , // |SDNE0 [MT48LC4M32B2B5-7_CS]              |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PH4 , // |ULPI_NXT [USB3300-EZK_NXT]               |    |+SCL|    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PH5 , // |SDNWE [MT48LC4M32B2B5-7_WE]              |    |+SDA|    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
...
PI3 , // |D27                                      |    |    |    |     |*MOSI|     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PI4 , // |FMC_NBL2 [MT48LC4M32B2B5-7_DQM2]         |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PI5 , // |FMC_NBL3 [MT48LC4M32B2B5-7_DGQM3]        |    |    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM8_CH1                                 |          |    |          |           
PI6 , // |D28                                      |    |    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM8_CH2                                 |          |    |          |           
PI7 , // |D29                                      |    |    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM8_CH3                                 |          |    |          |           
PI8 , // |MFX_IRQOUT [MFX_V3_IRQOUT]               |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PI9 , // |D30                                      |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PI10, // |D31                                      |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PI11, // |ULPI_DIR [USB3300-EZK_DIR]               |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PI12, // |                                         |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PI13, // |                                         |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PI14, // |                                         |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PI15, // |                                         |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |    |          |           
