...
PA1 , // |Vin_Sense [Buck/Boost Converter] |    |     |      |      |      |*IN2 |*TIM15_CH1N *TIM2_CH2                         |          |              
PA2 , // |                                 |    |     |      |*TX   |      |*IN3 |*TIM2_CH3 *TIM15_CH1                          |          |              
PA3 , // |Vout_Sense [Buck/Boost Converter]|    |     |      |*RX   |      |*IN4 |*TIM2_CH4 *TIM15_CH2                          |          |              
PA4 , // |                                 |    |     |      |      |      |     |*TIM3_CH2                                     |          |              
PA5 , // |                                 |    |*SCK |      |      |      |     |+TIM2_CH1                                     |          |              
PA6 , // |                                 |    |*MISO|      |      |      |     |*TIM3_CH1 *TIM16_CH1                          |          |              
PA7 , // |                                 |    |*MOSI|      |      |      |     |+TIM1_CH1N +TIM3_CH2 *TIM17_CH1               |          |              
PA8 , // |P1_Drive [Buck/Boost Converter]  |    |     |      |      |      |     |*HRTIM1_CHA1 *TIM1_CH1                        |          |              
PA9 , // |N1_Drive [Buck/Boost Converter]  |    |     |*TX   |      |      |     |*HRTIM1_CHA2 +TIM2_CH3 *TIM1_CH2              |          |              
PA10, // |N2_Drive [Buck/Boost Converter]  |    |     |*RX   |      |      |     |*HRTIM1_CHB1 +TIM2_CH4 *TIM1_CH3              |          |              
PA11, // |P2_Drive [Buck/Boost Converter]  |    |     |      |      |      |     |+TIM1_CH1N *HRTIM1_CHB2 *TIM1_CH4             |          |              
PA12, // |                                 |    |     |      |      |      |     |+TIM1_CH2N +TIM16_CH1                         |          |              
PA13, // |SWDIO                            |    |     |      |      |      |     |*TIM16_CH1N                                   |          |*JTMS-SWDIO   
PA14, // |SWCLK                            |*SDA|     |      |+TX   |      |     |                                              |          |*JTCK-SWCLK   
PA15, // |                                 |*SCL|     |      |+RX   |      |     |+TIM2_CH1                                     |          |*JTDI         
PB0 , // |BK_Sense [Led Buck Converter]    |    |     |      |      |      |*IN11|*TIM3_CH3 *TIM1_CH2N                          |          |              
PB1 , // |                                 |    |     |      |      |      |*IN12|+TIM1_CH3N *TIM3_CH4                          |          |              
PB2 , // |                                 |    |     |      |      |      |     |                                              |          |              
PB3 , // |                                 |    |+SCK |      |+TX   |      |     |+TIM2_CH2                                     |          |*JTDO-TRACESWO
PB4 , // |                                 |    |+MISO|      |+RX   |      |     |+TIM3_CH1 +TIM16_CH1                          |          |*NJTRST       
PB5 , // |                                 |    |+MOSI|      |      |      |     |+TIM3_CH2 +TIM17_CH1                          |          |              
PB6 , // |LD_U [LD3 Red Led]               |+SCL|     |+TX   |      |      |     |+TIM16_CH1N                                   |          |              
PB7 , // |LD_D [LD6 Blue Led]              |+SDA|     |+RX   |      |      |     |*TIM17_CH1N +TIM3_CH4                         |          |              
PB8 , // |LD_L [LD4 Orange Led]            |+SCL|     |      |      |+RX   |     |+TIM16_CH1                                    |          |              
PB9 , // |LD_R [LD5 Green Led]             |+SDA|     |      |      |+TX   |     |+TIM17_CH1                                    |          |              
PB10, // |                                 |    |     |      |      |*TX   |     |+TIM2_CH3                                     |          |              
PB11, // |                                 |    |     |      |      |*RX   |     |+TIM2_CH4                                     |          |              
PB12, // |BK_Drive [Led Buck Converter]    |    |     |      |      |      |     |*HRTIM1_CHC1                                  |          |              
PB13, // |                                 |    |     |      |      |      |*IN13|+TIM1_CH1N *HRTIM1_CHC2                       |          |              
PB14, // |RC [Buck/Boost Converter]        |    |     |      |      |      |     |*HRTIM1_CHD1 +TIM1_CH2N +TIM15_CH1            |          |              
PB15, // |                                 |    |     |      |      |      |     |*HRTIM1_CHD2 +TIM1_CH3N +TIM15_CH1N +TIM15_CH2|          |              
PC13, // |                                 |    |     |      |      |      |     |*TIM1_CH1N                                    |          |              
PC14, // |                                 |    |     |      |      |      |     |                                              |*OSC32_IN |              
PC15, // |                                 |    |     |      |      |      |     |                                              |*OSC32_OUT|              
PF0 , // |PF0-OSC_IN                       |    |     |      |      |      |     |*TIM1_CH3N                                    |*OSC_IN   |              
PF1 , // |PF1_OSC_OUT                      |    |     |      |      |      |     |                                              |*OSC_OUT  |              
NB_DIGITAL_PINS,
};
