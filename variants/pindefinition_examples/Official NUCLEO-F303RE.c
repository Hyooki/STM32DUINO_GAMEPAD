...
PA7 , // |                    |    |    |    |*MOSI|     |     |      |      |      |     |+TIM1_CH1N *TIM8_CH1N +TIM3_CH2 *TIM17_CH1|   |          |              
PA8 , // |                    |    |    |*SCL|     |     |     |      |      |      |     |+TIM1_CH1                                 |   |          |              
PA9 , // |                    |    |+SCL|    |     |     |     |+TX   |      |      |     |+TIM2_CH3 +TIM1_CH2                       |   |          |              
PA10, // |                    |    |+SDA|    |     |+MISO|     |+RX   |      |      |     |+TIM2_CH4 +TIM1_CH3                       |   |          |              
PA11, // |                    |    |    |    |     |+MOSI|     |      |      |      |     |+TIM1_CH1N +TIM1_CH4 *TIM4_CH1            |*DM|          |              
...
PB8 , // |                    |+SCL|    |    |     |     |     |      |      |+RX   |     |+TIM8_CH2 +TIM4_CH3 +TIM16_CH1            |   |          |              
PB9 , // |                    |+SDA|    |    |     |     |     |      |      |+TX   |     |+TIM17_CH1 +TIM8_CH3 *TIM4_CH4            |   |          |              
PB10, // |                    |    |    |    |     |     |     |      |      |*TX   |     |+TIM2_CH3                                 |   |          |              
