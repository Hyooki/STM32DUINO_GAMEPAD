...
PA4 , // |I2S3_WS [CS43L22_LRCK]        |    |    |    |     |     |     |     |     |      |      |      |*IN4 |                             |          |    |          |           
PA5 , // |SPI1_SCK [L3GD20_SC/SPC]      |    |    |    |*SCK |     |     |     |     |      |      |      |*IN5 |+TIM2_CH1                    |          |    |          |           
PA6 , // |SPI1_MISO [L3GD20_AS0/SDO]    |    |    |    |*MISO|     |     |     |     |      |      |      |*IN6 |*TIM3_CH1                    |          |*CMD|          |           
PA7 , // |SPI1_MOSI [L3GD20_SDA/SDI/SDO]|    |    |    |*MOSI|     |     |     |     |      |      |      |*IN7 |*TIM1_CH1N *TIM3_CH2         |          |    |          |           
PA8 , // |                              |    |    |*SCL|     |     |     |     |     |      |      |      |     |+TIM1_CH1                    |          |+D1 |          |           
PA9 , // |VBUS_FS                       |    |    |    |     |     |     |     |     |*TX   |      |      |     |+TIM1_CH2                    |          |*D2 |          |           
PA10, // |OTG_FS_ID                     |    |    |    |     |     |     |     |+MOSI|*RX   |      |      |     |+TIM1_CH3                    |          |    |          |           
PA11, // |OTG_FS_DM                     |    |    |    |     |     |     |+MISO|     |      |      |+TX   |     |+TIM1_CH4                    |*OTG_FS_DM|    |          |           
PA12, // |OTG_FS_DP                     |    |    |    |     |     |     |     |+MISO|      |      |+RX   |     |                             |*OTG_FS_DP|    |          |           
...
PB6 , // |Audio_SCL [CS43L22_SCL]       |*SCL|    |    |     |     |     |     |     |+TX   |      |      |     |+TIM4_CH1                    |          |    |          |           
PB7 , // |                              |*SDA|    |    |     |     |     |     |     |+RX   |      |      |     |+TIM4_CH2                    |          |+D0 |          |           
PB8 , // |                              |+SCL|    |+SDA|     |     |     |     |+MOSI|      |      |      |     |*TIM10_CH1 +TIM4_CH3         |          |*D4 |          |           
PB9 , // |Audio_SDA [CS43L22_SDA]       |+SDA|+SDA|    |     |     |     |     |     |      |      |      |     |+TIM4_CH4 *TIM11_CH1         |          |*D5 |          |           
PB10, // |CLK_IN [MP45DT02_CLK]         |    |*SCL|    |     |*SCK |     |     |     |      |      |      |     |+TIM2_CH3                    |          |*D7 |          |           
PB12, // |                              |    |    |    |     |     |*SCK |     |     |      |      |      |     |                             |          |    |          |           
PB13, // |                              |    |    |    |     |+SCK |     |+SCK |     |      |      |      |     |+TIM1_CH1N                   |          |    |          |           
PB14, // |                              |    |    |    |     |+MISO|     |     |     |      |      |      |     |+TIM1_CH2N                   |          |*D6 |          |           
PB15, // |                              |    |    |    |     |+MOSI|     |     |     |      |      |      |     |+TIM1_CH3N                   |          |*CK |          |           
PC0 , // |OTG_FS_PowerSwitchOn          |    |    |    |     |     |     |     |     |      |      |      |*IN10|                             |          |    |          |           
PC1 , // |                              |    |    |    |     |     |     |     |     |      |      |      |*IN11|                             |          |    |          |           
PC2 , // |                              |    |    |    |     |*MISO|     |     |     |      |      |      |*IN12|                             |          |    |          |           
PC3 , // |PDM_OUT [MP45DT02_DOUT]       |    |    |    |     |*MOSI|     |     |     |      |      |      |*IN13|                             |          |    |          |           
PC4 , // |                              |    |    |    |     |     |     |     |     |      |      |      |*IN14|                             |          |    |          |           
PC5 , // |                              |    |    |    |     |     |     |     |     |      |      |      |*IN15|                             |          |    |          |           
PC6 , // |                              |    |    |    |     |     |     |     |     |      |      |*TX   |     |+TIM3_CH1                    |          |+D6 |          |           
PC7 , // |I2S3_MCK [CS43L22_MCLK]       |    |    |    |     |+SCK |     |     |     |      |      |*RX   |     |+TIM3_CH2                    |          |+D7 |          |           
PC8 , // |                              |    |    |    |     |     |     |     |     |      |      |      |     |+TIM3_CH3                    |          |*D0 |          |           
PC9 , // |                              |    |    |*SDA|     |     |     |     |     |      |      |      |     |+TIM3_CH4                    |          |*D1 |          |           
PC10, // |I2S3_SCK [CS43L22_SCLK]       |    |    |    |     |     |+SCK |     |     |      |      |      |     |                             |          |+D2 |          |           
PC11, // |                              |    |    |    |     |     |*MISO|     |     |      |      |      |     |                             |          |*D3 |          |           
PC12, // |I2S3_SD [CS43L22_SDIN]        |    |    |    |     |     |*MOSI|     |     |      |      |      |     |                             |          |+CK |          |           
PC13, // |                              |    |    |    |     |     |     |     |     |      |      |      |     |                             |          |    |          |           
...
PD2 , // |                              |    |    |    |     |     |     |     |     |      |      |      |     |                             |          |+CMD|          |           
PD3 , // |                              |    |    |    |     |+SCK |     |     |     |      |      |      |     |                             |          |    |          |           
PD4 , // |Audio_RST [CS43L22_RESET]     |    |    |    |     |     |     |     |     |      |      |      |     |                             |          |    |          |           
PD5 , // |OTG_FS_OverCurrent            |    |    |    |     |     |     |     |     |      |+TX   |      |     |                             |          |    |          |           
PD6 , // |                              |    |    |    |     |     |+MOSI|     |     |      |+RX   |      |     |                             |          |    |          |           
PD7 , // |                              |    |    |    |     |     |     |     |     |      |      |      |     |                             |          |    |          |           
PD8 , // |                              |    |    |    |     |     |     |     |     |      |      |      |     |                             |          |    |          |           
PD9 , // |                              |    |    |    |     |     |     |     |     |      |      |      |     |                             |          |    |          |           
PD10, // |                              |    |    |    |     |     |     |     |     |      |      |      |     |                             |          |    |          |           
PD11, // |                              |    |    |    |     |     |     |     |     |      |      |      |     |                             |          |    |          |           
PD12, // |LD4 [Green Led]               |    |    |    |     |     |     |     |     |      |      |      |     |*TIM4_CH1                    |          |    |          |           
PD13, // |LD3 [Orange Led]              |    |    |    |     |     |     |     |     |      |      |      |     |*TIM4_CH2                    |          |    |          |           
PD14, // |LD5 [Red Led]                 |    |    |    |     |     |     |     |     |      |      |      |     |*TIM4_CH3                    |          |    |          |           
PD15, // |LD6 [Blue Led]                |    |    |    |     |     |     |     |     |      |      |      |     |*TIM4_CH4                    |          |    |          |           
PE0 , // |                              |    |    |    |     |     |     |     |     |      |      |      |     |                             |          |    |          |           
PE1 , // |MEMS_INT2 [L3GD20_INT2]       |    |    |    |     |     |     |     |     |      |      |      |     |                             |          |    |          |           
PE2 , // |                              |    |    |    |     |     |     |*SCK |*SCK |      |      |      |     |                             |          |    |          |*TRACECLK  
PE3 , // |CS_I2C/SPI [L3GD20_CS_I2C/SPI]|    |    |    |     |     |     |     |     |      |      |      |     |                             |          |    |          |*TRACED0   
PE4 , // |                              |    |    |    |     |     |     |     |     |      |      |      |     |                             |          |    |          |*TRACED1   
