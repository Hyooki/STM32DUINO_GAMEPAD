...
PA0 , // |ARDUINO A0                             |    |    |    |    |     |     |     |     |     |     |      |      |      |      |*IN0 |+TIM2_CH1 *TIM5_CH1                       |          |          |           
...
PA4 , // |DCMI_HSYNC                             |    |    |    |    |     |     |     |     |     |     |      |      |      |      |*IN4 |                                          |          |          |           
PA5 , // |ULPI_CLK [USB3320C-EZK_CLKOUT]         |    |    |    |    |+SCK |     |     |     |     |     |      |      |      |      |*IN5 |+TIM8_CH1N +TIM2_CH1                      |          |          |           
PA6 , // |                                       |    |    |    |    |+MISO|     |     |     |     |     |      |      |      |      |*IN6 |+TIM3_CH1 +TIM13_CH1                      |          |          |           
PA7 , // |RMII_CRS_DV [LAN8742A-CZ-TR_CRS_DV]    |    |    |    |    |+MOSI|     |     |     |     |     |      |      |      |      |*IN7 |+TIM8_CH1N +TIM14_CH1 +TIM3_CH2 +TIM1_CH1N|          |          |           
PA8 , // |ARDUINO PWM/D5                         |    |    |*SCL|    |     |     |     |     |     |     |      |      |      |      |     |*TIM1_CH1                                 |          |          |           
PA9 , // |VCP_TX [STM32F103CBT6_PA3]             |    |    |    |    |     |+SCK |     |     |     |     |+TX   |      |      |      |     |*TIM1_CH2                                 |          |          |           
PA10, // |OTG_FS_ID                              |    |    |    |    |     |     |     |     |     |     |+RX   |      |      |      |     |*TIM1_CH3                                 |          |          |           
PA11, // |OTG_FS_N                               |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM1_CH4                                 |*OTG_FS_DM|          |           
PA12, // |OTG_FS_P                               |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |*OTG_FS_DP|          |           
PA13, // |SWDIO                                  |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |*JTMS-SWDIO
PA14, // |SWCLK                                  |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |*JTCK-SWCLK
PA15, // |ARDUINO PWM/D9                         |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM2_CH1                                 |          |          |*JTDI      
...
PB4 , // |ARDUINO PWM/D3                         |    |    |    |    |*MISO|     |*MISO|     |     |     |      |      |      |      |     |*TIM3_CH1                                 |          |          |*JTRST     
PB5 , // |ULPI_D7 [USB3320C-EZK_D7]              |    |    |    |    |*MOSI|     |*MOSI|     |     |     |      |      |      |      |     |*TIM3_CH2                                 |          |          |           
PB6 , // |QSPI_NCS [N25Q128A13EF840E_S]          |+SCL|    |    |    |     |     |     |     |     |     |*TX   |      |      |      |     |*TIM4_CH1                                 |          |          |           
PB7 , // |VCP_RX [STM32F103CBT6_PA2]             |+SDA|    |    |    |     |     |     |     |     |     |*RX   |      |      |      |     |*TIM4_CH2                                 |          |          |           
PB8 , // |ARDUINO SCL/D15                        |*SCL|    |    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM10_CH1 *TIM4_CH3                      |          |          |           
PB9 , // |ARDUINO SDA/D14                        |*SDA|    |    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM11_CH1 *TIM4_CH4                      |          |          |           
...
PB14, // |ARDUINO MISO/D12                       |    |    |    |    |     |+MISO|     |     |     |     |      |      |      |      |     |+TIM12_CH1 +TIM8_CH2N +TIM1_CH2N          |*OTG_HS_DM|          |           
PB15, // |ARDUINO MOSI/PWM/D11                   |    |    |    |    |     |+MOSI|     |     |     |     |      |      |      |      |     |+TIM12_CH2 +TIM1_CH3N +TIM8_CH3N          |*OTG_HS_DP|          |           
PC0 , // |ULPI_STP [USB3320C-EZK_STP]            |    |    |    |    |     |     |     |     |     |     |      |      |      |      |*IN10|                                          |          |          |           
PC1 , // |RMII_MDC [LAN8742A-CZ-TR_MDC]          |    |    |    |    |     |+MOSI|     |     |     |     |      |      |      |      |*IN11|                                          |          |          |+TRACED0   
PC2 , // |ULPI_DIR [USB3320C-EZK_DIR]            |    |    |    |    |     |+MISO|     |     |     |     |      |      |      |      |*IN12|                                          |          |          |           
PC3 , // |FMC_SDCKE0 [MT48LC4M32B2B5-6A_CKE]     |    |    |    |    |     |+MOSI|     |     |     |     |      |      |      |      |*IN13|                                          |          |          |           
PC4 , // |RMII_RXD0 [LAN8742A-CZ-TR_RXD0]        |    |    |    |    |     |     |     |     |     |     |      |      |      |      |*IN14|                                          |          |          |           
PC5 , // |RMII_RXD1 [LAN8742A-CZ-TR_RXD1]        |    |    |    |    |     |     |     |     |     |     |      |      |      |      |*IN15|                                          |          |          |           
PC6 , // |ARDUINO TX/D1                          |    |    |    |    |     |     |     |     |     |     |      |      |      |+TX   |     |+TIM8_CH1 +TIM3_CH1                       |          |          |           
PC7 , // |ARDUINO RX/D0                          |    |    |    |    |     |     |     |     |     |     |      |      |      |+RX   |     |+TIM8_CH2 +TIM3_CH2                       |          |          |           
PC8 , // |                                       |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM3_CH3 +TIM8_CH3                       |          |          |+TRACED1   
PC9 , // |                                       |    |    |*SDA|    |     |     |     |     |     |     |      |      |      |      |     |+TIM8_CH4 *TIM3_CH4                       |          |          |           
PC10, // |SDMMC_D2                               |    |    |    |    |     |     |+SCK |     |     |     |      |      |*TX   |      |     |                                          |          |          |           
PC11, // |SDMMC_D3                               |    |    |    |    |     |     |+MISO|     |     |     |      |      |*RX   |      |     |                                          |          |          |           
PC12, // |SDMMC_CK                               |    |    |    |    |     |     |+MOSI|     |     |     |      |      |      |      |     |                                          |          |          |*TRACED3   
PC13, // |uSD_Detect                             |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PC14, // |RCC_OSC32_IN                           |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |*OSC32_IN |           
PC15, // |RCC_OSC32_OUT                          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |*OSC32_OUT|           
PD0 , // |FMC_D2 [MT48LC4M32B2B5-6A_DQ2]         |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PD1 , // |FMC_D3 [MT48LC4M32B2B5-6A_DQ3]         |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PD2 , // |SDMMC_CMD                              |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |+TRACED2   
PD3 , // |DCMI_D5                                |    |    |    |    |     |*SCK |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PD4 , // |OTG_FS_OverCurrent [STMPS2141STR_Fault]|    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PD5 , // |OTG_FS_PowerSwitchOn [STMPS2141STR_EN] |    |    |    |    |     |     |     |     |     |     |      |*TX   |      |      |     |                                          |          |          |           
PD6 , // |Audio_INT                              |    |    |    |    |     |     |+MOSI|     |     |     |      |*RX   |      |      |     |                                          |          |          |           
PD7 , // |SPDIF_RX0 [74LVC1G04SE_4]              |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PD8 , // |FMC_D13 [MT48LC4M32B2B5-6A_DQ13]       |    |    |    |    |     |     |     |     |     |     |      |      |+TX   |      |     |                                          |          |          |           
PD9 , // |FMC_D14 [MT48LC4M32B2B5-6A_DQ14]       |    |    |    |    |     |     |     |     |     |     |      |      |+RX   |      |     |                                          |          |          |           
PD10, // |FMC_D15 [MT48LC4M32B2B5-6A_DQ15]       |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PD11, // |QSPI_D0 [N25Q128A13EF840E_DQ0]         |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PD12, // |QSPI_D1 [N25Q128A13EF840E_DQ1]         |    |    |    |*SCL|     |     |     |     |     |     |      |      |      |      |     |+LPTIM1_IN1 +TIM4_CH1                     |          |          |           
...
PE3 , // |OTG_HS_OverCurrent [STMPS2151STR_FAULT]|    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |*TRACED0   
PE4 , // |LCD_B0 [RK043FN48H-CT672B_B0]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |*TRACED1   
PE5 , // |DCMI_D6                                |    |    |    |    |     |     |     |*MISO|     |     |      |      |      |      |     |*TIM9_CH1                                 |          |          |*TRACED2   
PE6 , // |DCMI_D7                                |    |    |    |    |     |     |     |*MOSI|     |     |      |      |      |      |     |*TIM9_CH2                                 |          |          |+TRACED3   
...
PF6 , // |ARDUINO A5                             |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |+TIM10_CH1                                |          |          |           
PF7 , // |ARDUINO A4                             |    |    |    |    |     |     |     |     |*SCK |     |      |      |      |      |     |+TIM11_CH1                                |          |          |           
...
PG9 , // |DCMI_VSYNC                             |    |    |    |    |     |     |     |     |     |     |      |      |      |*RX   |     |                                          |          |          |           
PG10, // |SAI2_SDB [WM8994ECS/R_ADCDAT1]         |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PG11, // |RMII_TX_EN [LAN8742A-CZ-TR_TXEN]       |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PG12, // |LCD_B4 [RK043FN48H-CT672B_B4]          |    |    |    |    |     |     |     |     |     |*MISO|      |      |      |      |     |*LPTIM1_IN1                               |          |          |           
...
PH7 , // |LCD_SCL [RK043FN48H-CT672B_SCL]        |    |    |+SCL|    |     |     |     |     |+MISO|     |      |      |      |      |     |                                          |          |          |           
PH8 , // |LCD_SDA [RK043FN48H-CT672B_SDA]        |    |    |+SDA|    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PH9 , // |DCMI_D0                                |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM12_CH2                                |          |          |           
PH10, // |DCMI_D1                                |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |+TIM5_CH1                                 |          |          |           
PH11, // |DCMI_D2                                |    |    |    |+SCL|     |     |     |     |     |     |      |      |      |      |     |+TIM5_CH2                                 |          |          |           
PH12, // |DCMI_D3                                |    |    |    |+SDA|     |     |     |     |     |     |      |      |      |      |     |*TIM5_CH3                                 |          |          |           
PH13, // |DCMI_PWR_EN                            |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM8_CH1N                                |          |          |           
PH14, // |DCMI_D4                                |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM8_CH2N                                |          |          |           
PH15, // |TP3                                    |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM8_CH3N                                |          |          |           
PI0 , // |ARDUINO PWM/CS/D10                     |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM5_CH4                                 |          |          |           
PI1 , // |ARDUINO SCK/D13                        |    |    |    |    |     |+SCK |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PI2 , // |ARDUINO D8                             |    |    |    |    |     |*MISO|     |     |     |     |      |      |      |      |     |*TIM8_CH4                                 |          |          |           
PI3 , // |ARDUINO D7                             |    |    |    |    |     |*MOSI|     |     |     |     |      |      |      |      |     |                                          |          |          |           
PI4 , // |SAI2_MCLKA [WM8994ECS/R_MCLK1]         |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PI5 , // |SAI2_SCKA [WM8994ECS/R_BCLK1]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM8_CH1                                 |          |          |           
PI6 , // |SAI2_SDA [WM8994ECS/R_DACDAT1]         |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM8_CH2                                 |          |          |           
PI7 , // |SAI2_FSA [WM8994ECS/R_LRCLK1]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM8_CH3                                 |          |          |           
PI8 , // |NC1 [TP2]                              |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PI9 , // |LCD_VSYNC [RK043FN48H-CT672B_VSYNC]    |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PI10, // |LCD_HSYNC [RK043FN48H-CT672B_HSYNC]    |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PI11, // |                                       |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PI12, // |LCD_DISP [RK043FN48H-CT672B_DISP]      |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PI13, // |LCD_INT                                |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PI14, // |LCD_CLK [RK043FN48H-CT672B_CLK]        |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PI15, // |LCD_R0 [RK043FN48H-CT672B_R0]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PJ0 , // |LCD_R1 [RK043FN48H-CT672B_R1]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PJ1 , // |LCD_R2 [RK043FN48H-CT672B_R2]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PJ2 , // |LCD_R3 [RK043FN48H-CT672B_R3]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PJ3 , // |LCD_R4 [RK043FN48H-CT672B_R4]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PJ4 , // |LCD_R5 [RK043FN48H-CT672B_R5]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PJ5 , // |LCD_R6 [RK043FN48H-CT672B_R6]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PJ6 , // |LCD_R7 [RK043FN48H-CT672B_R7]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PJ7 , // |LCD_G0 [RK043FN48H-CT672B_G0]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PJ8 , // |LCD_G1 [RK043FN48H-CT672B_G1]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PJ9 , // |LCD_G2 [RK043FN48H-CT672B_G2]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PJ10, // |LCD_G3 [RK043FN48H-CT672B_G3]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PJ11, // |LCD_G4 [RK043FN48H-CT672B_G4]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PJ12, // |OTG_FS_VBUS                            |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PJ13, // |LCD_B1 [RK043FN48H-CT672B_B1]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PJ14, // |LCD_B2 [RK043FN48H-CT672B_B2]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PJ15, // |LCD_B3 [RK043FN48H-CT672B_B3]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PK0 , // |LCD_G5 [RK043FN48H-CT672B_G5]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PK1 , // |LCD_G6 [RK043FN48H-CT672B_G6]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PK2 , // |LCD_G7 [RK043FN48H-CT672B_G7]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PK3 , // |LCD_BL_CTRL [STLD40DPUR_EN]            |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PK4 , // |LCD_B5 [RK043FN48H-CT672B_B5]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PK5 , // |LCD_B6 [RK043FN48H-CT672B_B6]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PK6 , // |LCD_B7 [RK043FN48H-CT672B_B7]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PK7 , // |LCD_DE [RK043FN48H-CT672B_DE]          |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
NB_DIGITAL_PINS,
};
