...
enum {
//*=default , +=alternate
//PIN    |BOARD LABEL|I2C1|SPI1 |USART1|TIM (PWM)                                 |RCC     |SYS   
PA0 , // |           |    |     |      |*TIM2_CH1                                 |        |      
PA1 , // |           |    |     |      |*TIM2_CH2                                 |        |      
PA2 , // |VCP_TX     |    |     |*TX   |*TIM2_CH3 +TIM15_CH1                      |        |      
PA3 , // |           |    |     |*RX   |+TIM15_CH2 *TIM2_CH4                      |        |      
PA4 , // |           |    |     |      |*TIM14_CH1                                |        |      
PA5 , // |           |    |*SCK |      |+TIM2_CH1                                 |        |      
...
remaps_t remaps {
    ...
    { USART1, RX   , GPIOA, GPIO_PIN_3  , GPIO_AF1_USART1                    },
    { USART1, RX   , GPIOB, GPIO_PIN_7  , GPIO_AF0_USART1                    },
    { USART1, RX   , GPIOA, GPIO_PIN_15 , GPIO_AF1_USART1                    },
    { USART1, TX   , GPIOA, GPIO_PIN_9  , GPIO_AF1_USART1                    },
    { USART1, TX   , GPIOA, GPIO_PIN_2  , GPIO_AF1_USART1                    },
    { USART1, TX   , GPIOB, GPIO_PIN_6  , GPIO_AF0_USART1                    },
    { USART1, TX   , GPIOA, GPIO_PIN_14 , GPIO_AF1_USART1                    },
