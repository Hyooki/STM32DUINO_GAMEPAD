...
enum {
//*=default , +=alternate
//PIN    |I2C1|I2C2|SPI1 |SPI2 |SPI3 |USART1|USART2|USART3|ADC1 |TIM (PWM)                      |USB|SDIO|RCC       |SYS           
PA0 , // |    |    |     |     |     |      |      |      |*IN0 |*TIM5_CH1 *TIM2_CH1            |   |    |          |              
PA1 , // |    |    |     |     |     |      |      |      |*IN1 |*TIM5_CH2 *TIM2_CH2            |   |    |          |              
PA2 , // |    |    |     |     |     |      |*TX   |      |*IN2 |*TIM5_CH3 *TIM2_CH3            |   |    |          |              
PA3 , // |    |    |     |     |     |      |*RX   |      |*IN3 |*TIM5_CH4 *TIM2_CH4            |   |    |          |              
PA4 , // |    |    |     |     |     |      |      |      |*IN4 |                               |   |    |          |              
PA5 , // |    |    |*SCK |     |     |      |      |      |*IN5 |                               |   |    |          |              
PA6 , // |    |    |*MISO|     |     |      |      |      |*IN6 |*TIM3_CH1                      |   |    |          |              
PA7 , // |    |    |*MOSI|     |     |      |      |      |*IN7 |+TIM1_CH1N *TIM8_CH1N *TIM3_CH2|   |    |          |              
PA8 , // |    |    |     |     |     |      |      |      |     |*TIM1_CH1                      |   |    |          |              
PA9 , // |    |    |     |     |     |*TX   |      |      |     |*TIM1_CH2                      |   |    |          |              
PA10, // |    |    |     |     |     |*RX   |      |      |     |*TIM1_CH3                      |   |    |          |              
PA11, // |    |    |     |     |     |      |      |      |     |*TIM1_CH4                      |*DM|    |          |              
...
PB2 , // |    |    |     |     |     |      |      |      |     |                               |   |    |          |              
PB3 , // |    |    |+SCK |     |*SCK |      |      |      |     |+TIM2_CH2                      |   |    |          |*JTDO-TRACESWO
...
PC4 , // |    |    |     |     |     |      |      |      |*IN14|                               |   |    |          |              
PC5 , // |    |    |     |     |     |      |      |      |*IN15|                               |   |    |          |              
PC6 , // |    |    |     |     |     |      |      |      |     |*TIM8_CH1 +TIM3_CH1            |   |*D6 |          |              
PC7 , // |    |    |     |     |     |      |      |      |     |+TIM3_CH2 *TIM8_CH2            |   |*D7 |          |              
PC8 , // |    |    |     |     |     |      |      |      |     |+TIM3_CH3 *TIM8_CH3            |   |*D0 |          |              
PC9 , // |    |    |     |     |     |      |      |      |     |+TIM3_CH4 *TIM8_CH4            |   |*D1 |          |              
PC10, // |    |    |     |     |+SCK |      |      |+TX   |     |                               |   |*D2 |          |              
PC11, // |    |    |     |     |+MISO|      |      |+RX   |     |                               |   |*D3 |          |              
PC12, // |    |    |     |     |+MOSI|      |      |      |     |                               |   |*CK |          |              
PC13, // |    |    |     |     |     |      |      |      |     |                               |   |    |          |              
