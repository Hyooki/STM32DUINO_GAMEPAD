...
enum {
//*=default , +=alternate
//PIN    |BOARD LABEL                   |I2C1|I2C2|SPI1 |SPI2 |USART1|USART2|USART3|TIM (PWM)           |USB|RCC       |SYS           
PA0 , // |B1 [Blue PushButton]          |    |    |     |     |      |      |      |*TIM2_CH1           |   |          |              
PA1 , // |SEG0 [GH08172T_SEG0]          |    |    |     |     |      |      |      |*TIM2_CH2           |   |          |              
PA2 , // |SEG1 [GH08172T_SEG1]          |    |    |     |     |      |*TX   |      |*TIM9_CH1 *TIM2_CH3 |   |          |              
PA3 , // |SEG2 [GH08172T_SEG2]          |    |    |     |     |      |*RX   |      |*TIM9_CH2 *TIM2_CH4 |   |          |              
PA4 , // |IDD_Measurement               |    |    |     |     |      |      |      |                    |   |          |              
PA5 , // |                              |    |    |*SCK |     |      |      |      |+TIM2_CH1           |   |          |              
PA6 , // |GRP2_Sampling [Touch_Slider_1]|    |    |*MISO|     |      |      |      |*TIM3_CH1 *TIM10_CH1|   |          |              
PA7 , // |GRP2_Ground [Touch_Slider_1]  |    |    |*MOSI|     |      |      |      |*TIM3_CH2 *TIM11_CH1|   |          |              
PA8 , // |COM0 [GH08172T_COM0]          |    |    |     |     |      |      |      |                    |   |          |              
PA9 , // |COM1 [GH08172T_COM1]          |    |    |     |     |*TX   |      |      |                    |   |          |              
PA10, // |COM2 [GH08172T_COM2]          |    |    |     |     |*RX   |      |      |                    |   |          |              
PA11, // |                              |    |    |+MISO|     |      |      |      |                    |*DM|          |              
PA12, // |                              |    |    |+MOSI|     |      |      |      |                    |*DP|          |              
PA13, // |SWDIO                         |    |    |     |     |      |      |      |                    |   |          |*JTMS-SWDIO   
PA14, // |SWCLK                         |    |    |     |     |      |      |      |                    |   |          |*JTCK-SWCLK   
PA15, // |SEG12 [GH08172T_SEG12]        |    |    |     |     |      |      |      |+TIM2_CH1           |   |          |*JTDI         
PB0 , // |GRP3_Sampling [Touch_Slider_3]|    |    |     |     |      |      |      |*TIM3_CH3           |   |          |              
PB1 , // |GRP3_Ground [Touch_Slider_3]  |    |    |     |     |      |      |      |*TIM3_CH4           |   |          |              
PB2 , // |                              |    |    |     |     |      |      |      |                    |   |          |              
PB3 , // |SEG3 [GH08172T_SEG3]          |    |    |+SCK |     |      |      |      |+TIM2_CH2           |   |          |*JTDO-TRACESWO
PB4 , // |SEG4 [GH08172T_SEG4]          |    |    |+MISO|     |      |      |      |+TIM3_CH1           |   |          |*JTRST        
PB5 , // |SEG5 [GH08172T_SEG5]          |    |    |+MOSI|     |      |      |      |+TIM3_CH2           |   |          |              
PB6 , // |LD4 [Blue Led]                |*SCL|    |     |     |+TX   |      |      |*TIM4_CH1           |   |          |              
PB7 , // |LD3 [Green Led]               |*SDA|    |     |     |+RX   |      |      |*TIM4_CH2           |   |          |*PVD_IN       
PB8 , // |SEG13 [GH08172T_SEG13]        |+SCL|    |     |     |      |      |      |+TIM10_CH1 *TIM4_CH3|   |          |              
PB9 , // |COM3 [GH08172T_COM3]          |+SDA|    |     |     |      |      |      |*TIM4_CH4 +TIM11_CH1|   |          |              
PB10, // |SEG6 [GH08172T_SEG6]          |    |*SCL|     |     |      |      |*TX   |+TIM2_CH3           |   |          |              
PB11, // |SEG7 [GH08172T_SEG7]          |    |*SDA|     |     |      |      |*RX   |+TIM2_CH4           |   |          |              
PB12, // |SEG8 [GH08172T_SEG8]          |    |    |     |     |      |      |      |+TIM10_CH1          |   |          |              
PB13, // |SEG9 [GH08172T_SEG9]          |    |    |     |*SCK |      |      |      |+TIM9_CH1           |   |          |              
PB14, // |SEG10 [GH08172T_SEG10]        |    |    |     |*MISO|      |      |      |+TIM9_CH2           |   |          |              
PB15, // |SEG11 [GH08172T_SEG11]        |    |    |     |*MOSI|      |      |      |+TIM11_CH1          |   |          |              
PC0 , // |SEG14 [GH08172T_SEG14]        |    |    |     |     |      |      |      |                    |   |          |              
PC1 , // |SEG15 [GH08172T_SEG15]        |    |    |     |     |      |      |      |                    |   |          |              
PC2 , // |SEG16 [GH08172T_SEG16]        |    |    |     |     |      |      |      |                    |   |          |              
PC3 , // |SEG17 [GH08172T_SEG17]        |    |    |     |     |      |      |      |                    |   |          |              
PC4 , // |GRP9_Sampling [Touch_Slider_2]|    |    |     |     |      |      |      |                    |   |          |              
PC5 , // |GRP9_Ground [Touch_Slider_2]  |    |    |     |     |      |      |      |                    |   |          |              
PC6 , // |SEG18 [GH08172T_SEG18]        |    |    |     |     |      |      |      |+TIM3_CH1           |   |          |              
PC7 , // |SEG19 [GH08172T_SEG19]        |    |    |     |     |      |      |      |+TIM3_CH2           |   |          |              
PC8 , // |SEG20 [GH08172T_SEG20]        |    |    |     |     |      |      |      |+TIM3_CH3           |   |          |              
PC9 , // |SEG21 [GH08172T_SEG21]        |    |    |     |     |      |      |      |+TIM3_CH4           |   |          |              
PC10, // |SEG22 [GH08172T_SEG22]        |    |    |     |     |      |      |+TX   |                    |   |          |              
PC11, // |SEG23 [GH08172T_SEG23]        |    |    |     |     |      |      |+RX   |                    |   |          |              
PC12, // |                              |    |    |     |     |      |      |      |                    |   |          |              
PC13, // |IDD_CNT_EN                    |    |    |     |     |      |      |      |                    |   |          |              
