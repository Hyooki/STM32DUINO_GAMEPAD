...
enum {
//*=default , +=alternate
//PIN    |BOARD LABEL         |FMPI2C1|I2C1|I2C2|I2C3|SPI1 |SPI2 |SPI3 |USART1|USART2|USART3|USART6|ADC1 |TIM (PWM)                                 |USB       |SDIO|RCC       |SYS        
PA0 , // |                    |       |    |    |    |     |     |     |      |      |      |      |*IN0 |*TIM2_CH1 *TIM5_CH1                       |          |    |          |           
PA1 , // |                    |       |    |    |    |     |     |     |      |      |      |      |*IN1 |*TIM2_CH2 *TIM5_CH2                       |          |    |          |           
PA2 , // |USART_TX            |       |    |    |    |     |     |     |      |*TX   |      |      |*IN2 |*TIM9_CH1 *TIM2_CH3 *TIM5_CH3             |          |    |          |           
PA3 , // |USART_RX            |       |    |    |    |     |     |     |      |*RX   |      |      |*IN3 |*TIM2_CH4 *TIM5_CH4 *TIM9_CH2             |          |    |          |           
PA4 , // |                    |       |    |    |    |     |     |     |      |      |      |      |*IN4 |                                          |          |    |          |           
PA5 , // |LD2 [Green Led]     |       |    |    |    |*SCK |     |     |      |      |      |      |*IN5 |*TIM8_CH1N +TIM2_CH1                      |          |    |          |           
...
PA14, // |TCK                 |       |    |    |    |     |     |     |      |      |      |      |     |                                          |          |    |          |*JTCK-SWCLK
PA15, // |                    |       |    |    |    |     |     |     |      |      |      |      |     |+TIM2_CH1                                 |          |    |          |*JTDI      
PB0 , // |                    |       |    |    |    |     |     |+MOSI|      |      |      |      |*IN8 |*TIM8_CH2N *TIM3_CH3 *TIM1_CH2N           |          |*D1 |          |           
PB1 , // |                    |       |    |    |    |     |     |     |      |      |      |      |*IN9 |*TIM3_CH4 *TIM1_CH3N *TIM8_CH3N           |          |*D2 |          |           
PB2 , // |                    |       |    |    |    |     |     |+MOSI|      |      |      |      |     |+TIM2_CH4                                 |          |*CK |          |           
PB3 , // |SWO                 |       |    |+SDA|    |+SCK |     |+SCK |      |      |      |      |     |+TIM2_CH2                                 |          |    |          |*JTDO-SWO  
PB4 , // |                    |       |    |    |+SDA|+MISO|     |+MISO|      |      |      |      |     |+TIM3_CH1                                 |          |    |          |*JTRST     
PB5 , // |                    |       |    |    |    |+MOSI|     |+MOSI|      |      |      |      |     |+TIM3_CH2                                 |          |    |          |           
PB6 , // |                    |       |*SCL|    |    |     |     |     |+TX   |      |      |      |     |*TIM4_CH1                                 |          |    |          |           
PB7 , // |                    |       |*SDA|    |    |     |     |     |+RX   |      |      |      |     |*TIM4_CH2                                 |          |    |          |           
PB8 , // |                    |       |+SCL|    |    |     |     |     |      |      |      |      |     |+TIM2_CH1 *TIM10_CH1 *TIM4_CH3            |          |*D4 |          |           
PB9 , // |                    |       |+SDA|    |    |     |     |     |      |      |      |      |     |*TIM11_CH1 +TIM2_CH2 *TIM4_CH4            |          |*D5 |          |           
...
PC7 , // |                    |*SDA   |*SDA|    |    |     |+SCK |     |      |      |      |*RX   |     |*TIM8_CH2 +TIM3_CH2                       |          |*D7 |          |           
PC8 , // |                    |       |    |    |    |     |     |     |      |      |      |      |     |*TIM8_CH3 +TIM3_CH3                       |          |*D0 |          |*TRACED0   
PC9 , // |                    |       |    |    |*SDA|     |     |     |      |      |      |      |     |*TIM8_CH4 +TIM3_CH4                       |          |+D1 |          |           
PC10, // |                    |       |    |    |    |     |     |*SCK |      |      |+TX   |      |     |                                          |          |+D2 |          |           
PC11, // |                    |       |    |    |    |     |     |*MISO|      |      |+RX   |      |     |                                          |          |*D3 |          |           
PC12, // |                    |       |    |*SDA|    |     |     |+MOSI|      |      |      |      |     |                                          |          |+CK |          |           
