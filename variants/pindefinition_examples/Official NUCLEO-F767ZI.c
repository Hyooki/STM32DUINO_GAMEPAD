...
PB2 , // |                                     |    |    |    |    |     |     |*MOSI|     |     |     |      |      |      |      |     |                                          |          |          |           
PB3 , // |SWO                                  |    |    |    |    |+SCK |     |+SCK |     |     |+SCK |      |      |      |      |     |+TIM2_CH2                                 |          |          |*JTDO-SWO  
PB4 , // |                                     |    |    |    |    |+MISO|     |+MISO|     |     |+MISO|      |      |      |      |     |+TIM3_CH1                                 |          |          |*JTRST     
PB5 , // |                                     |    |    |    |    |+MOSI|     |+MOSI|     |     |+MOSI|      |      |      |      |     |+TIM3_CH2                                 |          |          |           
PB6 , // |                                     |*SCL|    |    |+SCL|     |     |     |     |     |     |+TX   |      |      |      |     |+TIM4_CH1                                 |          |          |           
PB7 , // |LD2 [Blue]                           |*SDA|    |    |+SDA|     |     |     |     |     |     |+RX   |      |      |      |     |+TIM4_CH2                                 |          |          |           
PB8 , // |                                     |+SCL|    |    |+SCL|     |     |     |     |     |     |      |      |      |      |     |+TIM10_CH1 +TIM4_CH3                      |          |          |           
PB9 , // |                                     |+SDA|    |    |+SDA|     |     |     |     |     |     |      |      |      |      |     |+TIM11_CH1 +TIM4_CH4                      |          |          |           
PB10, // |                                     |    |+SCL|    |    |     |*SCK |     |     |     |     |      |      |*TX   |      |     |+TIM2_CH3                                 |          |          |           
PB11, // |                                     |    |+SDA|    |    |     |     |     |     |     |     |      |      |*RX   |      |     |+TIM2_CH4                                 |          |          |           
PB12, // |                                     |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PB13, // |RMII_TXD1 [LAN8742A-CZ-TR_TXD1]      |    |    |    |    |     |+SCK |     |     |     |     |      |      |      |      |     |+TIM1_CH1N                                |          |          |           
PB14, // |LD3 [Red]                            |    |    |    |    |     |+MISO|     |     |     |     |*TX   |      |      |      |     |*TIM12_CH1 +TIM8_CH2N +TIM1_CH2N          |*OTG_HS_DM|          |           
PB15, // |                                     |    |    |    |    |     |+MOSI|     |     |     |     |*RX   |      |      |      |     |*TIM12_CH2 +TIM1_CH3N +TIM8_CH3N          |*OTG_HS_DP|          |           
PC0 , // |                                     |    |    |    |    |     |     |     |     |     |     |      |      |      |      |*IN10|                                          |          |          |           
...
PC6 , // |                                     |    |    |    |    |     |     |     |     |     |     |      |      |      |*TX   |     |*TIM8_CH1 +TIM3_CH1                       |          |          |           
PC7 , // |                                     |    |    |    |    |     |     |     |     |     |     |      |      |      |*RX   |     |*TIM8_CH2 +TIM3_CH2                       |          |          |           
PC8 , // |                                     |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |+TIM3_CH3 *TIM8_CH3                       |          |          |+TRACED1   
PC9 , // |                                     |    |    |*SDA|    |     |     |     |     |     |     |      |      |      |      |     |*TIM8_CH4 +TIM3_CH4                       |          |          |           
PC10, // |                                     |    |    |    |    |     |     |*SCK |     |     |     |      |      |+TX   |      |     |                                          |          |          |           
PC11, // |                                     |    |    |    |    |     |     |*MISO|     |     |     |      |      |+RX   |      |     |                                          |          |          |           
PC12, // |                                     |    |    |    |    |     |     |+MOSI|     |     |     |      |      |      |      |     |                                          |          |          |+TRACED3   
PC13, // |User Blue Button [B1]                |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PC14, // |                                     |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |*OSC32_IN |           
PC15, // |                                     |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |*OSC32_OUT|           
PD0 , // |                                     |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PD1 , // |                                     |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
...
uart_conf_t g_uart_config[] = {
  {
    ...
    .tx_port = GPIOB, .tx_pin = GPIO_PIN_14,
    .rx_port = GPIOB, .rx_pin = GPIO_PIN_15,
