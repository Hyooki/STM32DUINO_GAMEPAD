...
PA9 , // |           |*SCL|     |+TX   |+TIM22_CH1            |          |       
PA10, // |           |*SDA|     |+RX   |+TIM22_CH2            |          |       
PA11, // |           |    |+MISO|      |+TIM21_CH2            |          |       
PA12, // |           |    |+MOSI|      |                      |          |       
PA13, // |TMS        |    |     |      |                      |          |*SWDIO 
PA14, // |TCK        |    |     |+TX   |                      |          |*SWCLK 
...
PB4 , // |           |    |+MISO|      |+TIM22_CH1            |          |       
PB5 , // |           |    |+MOSI|      |+TIM22_CH2 +LPTIM1_IN1|          |       
PB6 , // |           |+SCL|     |+TX   |+TIM21_CH1            |          |       
...
remaps_t remaps {
    ...
    { TIM22 , CH2  , GPIOA, GPIO_PIN_10 , GPIO_AF5_TIM22                     },
