...
enum {
//*=default , +=alternate
//PIN    |BOARD LABEL         |I2C1|I2C2|SPI1 |SPI2 |SPI3 |USART1|USART2|USART3|TIM (PWM)                    |USB|RCC       |SYS           
PA0 , // |                    |    |    |     |     |     |      |      |      |*TIM5_CH1 *TIM2_CH1          |   |          |              
PA1 , // |                    |    |    |     |     |     |      |      |      |*TIM5_CH2 *TIM2_CH2          |   |          |              
PA2 , // |USART_TX            |    |    |     |     |     |      |*TX   |      |*TIM5_CH3 *TIM9_CH1 *TIM2_CH3|   |          |              
PA3 , // |USART_RX            |    |    |     |     |     |      |*RX   |      |*TIM5_CH4 *TIM9_CH2 *TIM2_CH4|   |          |              
PA4 , // |                    |    |    |     |     |     |      |      |      |                             |   |          |              
PA5 , // |LD2 [Green Led]     |    |    |*SCK |     |     |      |      |      |+TIM2_CH1                    |   |          |              
PA6 , // |                    |    |    |*MISO|     |     |      |      |      |*TIM3_CH1 *TIM10_CH1         |   |          |              
PA7 , // |                    |    |    |*MOSI|     |     |      |      |      |*TIM3_CH2 *TIM11_CH1         |   |          |              
PA8 , // |                    |    |    |     |     |     |      |      |      |                             |   |          |              
PA9 , // |                    |    |    |     |     |     |*TX   |      |      |                             |   |          |              
PA10, // |                    |    |    |     |     |     |*RX   |      |      |                             |   |          |              
PA11, // |                    |    |    |+MISO|     |     |      |      |      |                             |*DM|          |              
...
PB1 , // |                    |    |    |     |     |     |      |      |      |*TIM3_CH4                    |   |          |              
PB2 , // |                    |    |    |     |     |     |      |      |      |                             |   |          |              
PB3 , // |SWO                 |    |    |+SCK |     |+SCK |      |      |      |+TIM2_CH2                    |   |          |*JTDO-TRACESWO
PB4 , // |                    |    |    |+MISO|     |+MISO|      |      |      |+TIM3_CH1                    |   |          |*JTRST        
PB5 , // |                    |    |    |+MOSI|     |+MOSI|      |      |      |+TIM3_CH2                    |   |          |              
PB6 , // |                    |*SCL|    |     |     |     |+TX   |      |      |*TIM4_CH1                    |   |          |              
PB7 , // |                    |*SDA|    |     |     |     |+RX   |      |      |*TIM4_CH2                    |   |          |*PVD_IN       
PB8 , // |                    |+SCL|    |     |     |     |      |      |      |+TIM10_CH1 *TIM4_CH3         |   |          |              
PB9 , // |                    |+SDA|    |     |     |     |      |      |      |*TIM4_CH4 +TIM11_CH1         |   |          |              
