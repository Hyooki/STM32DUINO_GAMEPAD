...
enum {
//*=default , +=alternate
//PIN    |BOARD LABEL         |FMPI2C1|I2C1|I2C2|SPI1 |SPI2 |SPI5 |USART1|USART2|USART6|ADC1 |TIM (PWM)          |RCC       |SYS        
PA0 , // |                    |       |    |    |     |     |     |      |      |      |*IN0 |*TIM5_CH1          |          |           
PA1 , // |                    |       |    |    |     |     |     |      |      |      |*IN1 |*TIM5_CH2          |          |           
PA2 , // |USART_TX            |       |    |    |     |     |     |      |*TX   |      |*IN2 |*TIM5_CH3 *TIM9_CH1|          |           
PA3 , // |USART_RX            |       |    |    |     |     |     |      |*RX   |      |*IN3 |*TIM5_CH4 *TIM9_CH2|          |           
PA4 , // |                    |       |    |    |     |     |     |      |      |      |*IN4 |                   |          |           
PA5 , // |LD2 [Green Led]     |       |    |    |*SCK |     |     |      |      |      |*IN5 |                   |          |           
PA6 , // |                    |       |    |    |*MISO|     |     |      |      |      |*IN6 |                   |          |           
PA7 , // |                    |       |    |    |*MOSI|     |     |      |      |      |*IN7 |*TIM1_CH1N         |          |           
PA8 , // |                    |+SCL   |+SCL|    |     |     |     |      |      |      |     |*TIM1_CH1          |          |           
PA9 , // |                    |       |    |    |     |     |     |*TX   |      |      |     |*TIM1_CH2          |          |           
...
PA14, // |TCK                 |       |    |    |     |     |     |      |      |      |     |                   |          |*JTCK-SWCLK
PA15, // |                    |       |    |    |     |     |     |+TX   |      |      |     |                   |          |*JTDI      
PB0 , // |                    |       |    |    |     |     |*SCK |      |      |      |*IN8 |*TIM1_CH2N         |          |           
PB1 , // |                    |       |    |    |     |     |     |      |      |      |*IN9 |*TIM1_CH3N         |          |           
PB2 , // |                    |       |    |    |     |     |     |      |      |      |     |                   |          |           
PB3 , // |SWO                 |+SDA   |+SDA|+SDA|+SCK |     |     |+RX   |      |      |     |                   |          |*JTDO-SWO  
PB4 , // |                    |       |    |    |+MISO|     |     |      |      |      |     |                   |          |*JTRST     
PB5 , // |                    |       |    |    |+MOSI|     |     |      |      |      |     |+LPTIM1_IN1        |          |           
PB6 , // |                    |       |*SCL|    |     |     |     |+TX   |      |      |     |                   |          |           
PB7 , // |                    |       |*SDA|    |     |     |     |+RX   |      |      |     |+LPTIM1_IN2        |          |           
PB8 , // |                    |       |+SCL|    |     |     |+MOSI|      |      |      |     |                   |          |           
PB9 , // |                    |       |+SDA|+SDA|     |     |     |      |      |      |     |+TIM11_CH1         |          |           
PB10, // |                    |*SCL   |*SCL|*SCL|     |*SCK |     |      |      |      |     |                   |          |           
PB11, // |                    |       |    |*SDA|     |     |     |      |      |      |     |+TIM5_CH4          |          |*TRACED3   
PB12, // |                    |       |    |    |     |     |     |      |      |      |     |+TIM5_CH1          |          |           
PB13, // |                    |       |    |    |     |+SCK |     |      |      |      |     |+TIM1_CH1N         |          |           
PB14, // |                    |*SDA   |*SDA|    |     |+MISO|     |      |      |      |     |+TIM1_CH2N         |          |           
PB15, // |                    |+SCL   |+SCL|    |     |+MOSI|     |      |      |      |     |+TIM1_CH3N         |          |           
PC0 , // |                    |       |    |    |     |     |     |      |      |      |*IN10|*LPTIM1_IN1        |          |           
PC1 , // |                    |       |    |    |     |     |     |      |      |      |*IN11|                   |          |           
PC2 , // |                    |       |    |    |     |*MISO|     |      |      |      |*IN12|*LPTIM1_IN2        |          |           
PC3 , // |                    |       |    |    |     |*MOSI|     |      |      |      |*IN13|                   |          |           
PC4 , // |                    |       |    |    |     |     |     |      |      |      |*IN14|+TIM9_CH1          |          |           
PC5 , // |                    |       |    |    |     |     |     |      |      |      |*IN15|+TIM9_CH2          |          |           
PC6 , // |                    |+SCL   |+SCL|    |     |     |     |      |      |*TX   |     |                   |          |*TRACECLK  
PC7 , // |                    |+SDA   |+SDA|    |     |+SCK |     |      |      |*RX   |     |                   |          |           
PC8 , // |                    |       |    |    |     |     |     |      |      |      |     |                   |          |           
PC9 , // |                    |+SDA   |+SDA|    |     |     |     |      |      |      |     |                   |          |           
PC10, // |                    |       |    |    |     |     |     |      |      |      |     |+TIM5_CH2          |          |*TRACED0   
PC11, // |                    |       |    |    |     |     |     |      |      |      |     |+TIM5_CH3          |          |*TRACED1   
PC12, // |                    |       |    |    |     |     |     |      |      |      |     |*TIM11_CH1         |          |*TRACED2   
...
remaps_t remaps {
    ...
    { TIM11 , CH1  , GPIOC, GPIO_PIN_12 , GPIO_AF3_TIM11                     },
    ...
    { TIM5  , CH1  , GPIOB, GPIO_PIN_12 , GPIO_AF2_TIM5                      },
    { TIM5  , CH2  , GPIOA, GPIO_PIN_1  , GPIO_AF2_TIM5                      },
    { TIM5  , CH2  , GPIOC, GPIO_PIN_10 , GPIO_AF2_TIM5                      },
    { TIM5  , CH3  , GPIOA, GPIO_PIN_2  , GPIO_AF2_TIM5                      },
    { TIM5  , CH3  , GPIOC, GPIO_PIN_11 , GPIO_AF2_TIM5                      },
    { TIM5  , CH4  , GPIOB, GPIO_PIN_11 , GPIO_AF2_TIM5                      },
    { TIM5  , CH4  , GPIOA, GPIO_PIN_3  , GPIO_AF2_TIM5                      },
    { TIM9  , CH1  , GPIOA, GPIO_PIN_2  , GPIO_AF3_TIM9                      },
    { TIM9  , CH1  , GPIOC, GPIO_PIN_4  , GPIO_AF3_TIM9                      },
    { TIM9  , CH2  , GPIOA, GPIO_PIN_3  , GPIO_AF3_TIM9                      },
    { TIM9  , CH2  , GPIOC, GPIO_PIN_5  , GPIO_AF3_TIM9                      },
