...
PA5 , // |SPI1_SCK [LIS302DL_SCL/SPC]     |    |    |    |*SCK |     |     |      |      |      |      |*IN5 |*TIM8_CH1N +TIM2_CH1                      |          |    |          |           
PA6 , // |SPI1_MISO [LIS302DL_SDO]        |    |    |    |*MISO|     |     |      |      |      |      |*IN6 |*TIM3_CH1 *TIM13_CH1                      |          |    |          |           
PA7 , // |SPI1_MOSI [LIS302DL_SDA/SDI/SDO]|    |    |    |*MOSI|     |     |      |      |      |      |*IN7 |*TIM1_CH1N +TIM8_CH1N *TIM3_CH2 *TIM14_CH1|          |    |          |           
PA8 , // |                                |    |    |*SCL|     |     |     |      |      |      |      |     |+TIM1_CH1                                 |          |    |          |           
PA9 , // |VBUS_FS                         |    |    |    |     |     |     |*TX   |      |      |      |     |+TIM1_CH2                                 |          |    |          |           
PA10, // |OTG_FS_ID                       |    |    |    |     |     |     |*RX   |      |      |      |     |+TIM1_CH3                                 |          |    |          |           
PA11, // |OTG_FS_DM                       |    |    |    |     |     |     |      |      |      |      |     |+TIM1_CH4                                 |*OTG_FS_DM|    |          |           
PA12, // |OTG_FS_DP                       |    |    |    |     |     |     |      |      |      |      |     |                                          |*OTG_FS_DP|    |          |           
...
PB10, // |CLK_IN [MP45DT02_CLK]           |    |*SCL|    |     |*SCK |     |      |      |*TX   |      |     |+TIM2_CH3                                 |          |    |          |           
PB11, // |                                |    |*SDA|    |     |     |     |      |      |*RX   |      |     |+TIM2_CH4                                 |          |    |          |           
PB12, // |                                |    |    |    |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PB13, // |                                |    |    |    |     |+SCK |     |      |      |      |      |     |+TIM1_CH1N                                |          |    |          |           
PB14, // |                                |    |    |    |     |+MISO|     |      |      |      |      |     |+TIM8_CH2N +TIM1_CH2N *TIM12_CH1          |*OTG_HS_DM|    |          |           
...
PC7 , // |I2S3_MCK [CS43L22_MCLK]         |    |    |    |     |     |     |      |      |      |*RX   |     |+TIM3_CH2 *TIM8_CH2                       |          |*D7 |          |           
PC8 , // |                                |    |    |    |     |     |     |      |      |      |      |     |+TIM3_CH3 *TIM8_CH3                       |          |*D0 |          |           
PC9 , // |                                |    |    |*SDA|     |     |     |      |      |      |      |     |+TIM3_CH4 *TIM8_CH4                       |          |*D1 |          |           
PC10, // |I2S3_SCK [CS43L22_SCLK]         |    |    |    |     |     |*SCK |      |      |+TX   |      |     |                                          |          |*D2 |          |           
PC11, // |                                |    |    |    |     |     |*MISO|      |      |+RX   |      |     |                                          |          |*D3 |          |           
...
PE0 , // |                                |    |    |    |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PE1 , // |MEMS_INT2 [LIS302DL_INT2]       |    |    |    |     |     |     |      |      |      |      |     |                                          |          |    |          |           
PE2 , // |                                |    |    |    |     |     |     |      |      |      |      |     |                                          |          |    |          |*TRACECLK  
PE3 , // |CS_I2C/SPI [LIS302DL_CS_I2C/SPI]|    |    |    |     |     |     |      |      |      |      |     |                                          |          |    |          |*TRACED0   
PE4 , // |                                |    |    |    |     |     |     |      |      |      |      |     |                                          |          |    |          |*TRACED1   
