...
PA4 , // |PAR_HSYNC                                  |    |    |    |    |     |     |     |     |     |     |      |      |      |      |*IN4 |                                          |          |          |           
PA5 , // |ULPI_CK [USB3300-EZK_CLKOUT]               |    |    |    |    |+SCK |     |     |     |     |+SCK |      |      |      |      |*IN5 |+TIM8_CH1N +TIM2_CH1                      |          |          |           
PA6 , // |PAR_PCLK                                   |    |    |    |    |+MISO|     |     |     |     |+MISO|      |      |      |      |*IN6 |+TIM3_CH1 +TIM13_CH1                      |          |          |           
PA7 , // |MII_RX_DV [DP83848CVV_RX_DV]               |    |    |    |    |+MOSI|     |     |     |     |+MOSI|      |      |      |      |*IN7 |+TIM8_CH1N +TIM14_CH1 +TIM3_CH2 +TIM1_CH1N|          |          |           
PA8 , // |MII_MCO [DP83848CVV_X1]                    |    |    |*SCL|    |     |     |     |     |     |     |      |      |      |      |     |*TIM1_CH1                                 |          |          |           
PA9 , // |RS2320IrDA0T [ST3241EBPR_T2IN]             |    |    |    |    |     |+SCK |     |     |     |     |+TX   |      |      |      |     |*TIM1_CH2                                 |          |          |           
PA10, // |RS232/IrDA_RX [ST3241EBPR_R3OUT]           |    |    |    |    |     |     |     |     |     |     |+RX   |      |      |      |     |*TIM1_CH3                                 |          |          |           
PA11, // |USB_FS1_DM                                 |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM1_CH4                                 |*OTG_FS_DM|          |           
PA12, // |USB_FS1_DP                                 |    |    |    |    |     |*SCK |     |     |     |     |      |      |      |      |     |                                          |*OTG_FS_DP|          |           
...
PB3 , // |SD2_D2 [SMS064FF_1]                        |    |    |    |    |*SCK |     |*SCK |     |     |*SCK |      |      |      |      |     |*TIM2_CH2                                 |          |          |*JTDO-SWO  
PB4 , // |SD2_D3 [SMS064FF_2]                        |    |    |    |    |*MISO|     |*MISO|     |     |*MISO|      |      |      |      |     |*TIM3_CH1                                 |          |          |*JTRST     
PB5 , // |ULPI_D7 [USB3300-EZK_D7]                   |    |    |    |    |*MOSI|     |*MOSI|     |     |+MOSI|      |      |      |      |     |*TIM3_CH2                                 |          |          |           
PB6 , // |QSPI_BK1_NCS [MT25QL512ABA8ESF-0SIT_CS]    |+SCL|    |    |+SCL|     |     |     |     |     |     |*TX   |      |      |      |     |*TIM4_CH1                                 |          |          |           
PB7 , // |PAR_VSYNC                                  |+SDA|    |    |+SDA|     |     |     |     |     |     |*RX   |      |      |      |     |*TIM4_CH2                                 |          |          |           
PB8 , // |I2C1_SCL [WM8994ECS/R_SCLK]                |*SCL|    |    |*SCL|     |     |     |     |     |     |      |      |      |      |     |*TIM10_CH1 *TIM4_CH3                      |          |          |           
PB9 , // |I2C1_SDA [WM8994ECS/R_SDA]                 |*SDA|    |    |*SDA|     |     |     |     |     |     |      |      |      |      |     |*TIM11_CH1 *TIM4_CH4                      |          |          |           
...
PB14, // |USB_FS2_DM                                 |    |    |    |    |     |+MISO|     |     |     |     |+TX   |      |      |      |     |+TIM12_CH1 +TIM8_CH2N +TIM1_CH2N          |*OTG_HS_DM|          |           
PB15, // |USB_FS2_DP                                 |    |    |    |    |     |+MOSI|     |     |     |     |+RX   |      |      |      |     |+TIM12_CH2 +TIM1_CH3N +TIM8_CH3N          |*OTG_HS_DP|          |           
...
PC6 , // |FMC_NWAIT [PC28F128M29EWLA_RB]             |    |    |    |    |     |     |     |     |     |     |      |      |      |+TX   |     |+TIM8_CH1 +TIM3_CH1                       |          |          |           
PC7 , // |FMC_NE1 [PC28F128M29EWLA_E]                |    |    |    |    |     |     |     |     |     |     |      |      |      |+RX   |     |+TIM8_CH2 +TIM3_CH2                       |          |          |           
PC8 , // |SD1_D0 [SMS064FF_7]                        |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |*TIM3_CH3 +TIM8_CH3                       |          |          |+TRACED1   
PC9 , // |SD1_D1 [SMS064FF_8]                        |    |    |*SDA|    |     |     |     |     |     |     |      |      |      |      |     |+TIM8_CH4 *TIM3_CH4                       |          |          |           
PC10, // |SD1_D2 [SMS064FF_1]                        |    |    |    |    |     |     |+SCK |     |     |     |      |      |*TX   |      |     |                                          |          |          |           
PC11, // |SD1_D3 [SMS064FF_2]                        |    |    |    |    |     |     |+MISO|     |     |     |      |      |*RX   |      |     |                                          |          |          |           
PC12, // |SD1_CLK [SMS064FF_5]                       |    |    |    |    |     |     |+MOSI|     |     |     |      |      |      |      |     |                                          |          |          |*TRACED3   
...
PD2 , // |SD1_CMD [SMS064FF_3]                       |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |+TRACED2   
PD3 , // |PAR_D5                                     |    |    |    |    |     |+SCK |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PD4 , // |FMC_NOE [IS61WV102416BLL_OE]               |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PD5 , // |FMC_NWE [IS61WV102416BLL_WE]               |    |    |    |    |     |     |     |     |     |     |      |*TX   |      |      |     |                                          |          |          |           
PD6 , // |SD2_CLK [SMS064FF_5]                       |    |    |    |    |     |     |+MOSI|     |     |     |      |*RX   |      |      |     |                                          |          |          |           
PD7 , // |SD2_CMD [SMS064FF_3]                       |    |    |    |    |+MOSI|     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
...
PG4 , // |A14 [IS61WV102416BLL_A14]                  |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PG5 , // |A15 [IS61WV102416BLL_A15]                  |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PG6 , // |FMC_NE3 [IS61WV102416BLL_WE]               |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PG7 , // |NAND_INT                                   |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PG8 , // |SDCLK [IS42S32800G_CLK]                    |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PG9 , // |SAI2_FSB [WM8994ECS/R_LRCLK1]              |    |    |    |    |+MISO|     |     |     |     |     |      |      |      |*RX   |     |                                          |          |          |           
PG10, // |SD2_D1 [SMS064FF_8]                        |    |    |    |    |     |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
PG11, // |MII_TX_EN [DP83848CVV_TX_EN]               |    |    |    |    |+SCK |     |     |     |     |     |      |      |      |      |     |                                          |          |          |           
