...
PA0 , // |B1 [Blue PushButton]          |    |    |     |     |     |      |      |      |*IN1 |*TIM2_CH1                                 |   |          |              
PA1 , // |                              |    |    |     |     |     |      |      |      |*IN2 |*TIM15_CH1N *TIM2_CH2                     |   |          |              
PA2 , // |STLINK_TX                     |    |    |     |     |     |      |*TX   |      |*IN3 |*TIM2_CH3 +TIM15_CH1                      |   |          |              
PA3 , // |STLINK_RX                     |    |    |     |     |     |      |*RX   |      |*IN4 |*TIM2_CH4 +TIM15_CH2                      |   |          |              
PA4 , // |                              |    |    |     |     |     |      |      |      |     |+TIM3_CH2                                 |   |          |              
PA5 , // |SPI1_SCK [L3GD20_SCL/SPC]     |    |    |*SCK |     |     |      |      |      |     |+TIM2_CH1                                 |   |          |              
PA6 , // |SPI1_MISO [L3GD20_SA0/SDO]    |    |    |*MISO|     |     |      |      |      |     |+TIM3_CH1 *TIM16_CH1                      |   |          |              
PA7 , // |SPI1_MISO [L3GD20_SDA/SDI/SDO]|    |    |*MOSI|     |     |      |      |      |     |+TIM1_CH1N *TIM8_CH1N +TIM3_CH2 *TIM17_CH1|   |          |              
PA8 , // |                              |    |    |     |     |     |      |      |      |     |+TIM1_CH1                                 |   |          |              
PA9 , // |                              |    |+SCL|     |     |     |+TX   |      |      |     |+TIM2_CH3 +TIM1_CH2                       |   |          |              
PA10, // |                              |    |+SDA|     |     |     |+RX   |      |      |     |+TIM2_CH4 +TIM1_CH3                       |   |          |              
PA11, // |DM                            |    |    |     |     |     |      |      |      |     |+TIM1_CH1N +TIM1_CH4 +TIM4_CH1            |*DM|          |              
PA12, // |DP                            |    |    |     |     |     |      |      |      |     |+TIM1_CH2N +TIM4_CH2 +TIM16_CH1           |*DP|          |              
PA13, // |SWDIO                         |    |    |     |     |     |      |      |      |     |*TIM16_CH1N +TIM4_CH3                     |   |          |*JTMS-SWDIO   
PA14, // |SWCLK                         |*SDA|    |     |     |     |      |+TX   |      |     |+TIM8_CH2                                 |   |          |*JTCK-SWCLK   
PA15, // |                              |*SCL|    |     |     |     |      |+RX   |      |     |+TIM8_CH1 +TIM2_CH1                       |   |          |*JTDI         
PB0 , // |                              |    |    |     |     |     |      |      |      |     |*TIM8_CH2N +TIM3_CH3 *TIM1_CH2N           |   |          |              
PB1 , // |                              |    |    |     |     |     |      |      |      |     |+TIM1_CH3N *TIM8_CH3N +TIM3_CH4           |   |          |              
PB2 , // |                              |    |    |     |     |     |      |      |      |     |                                          |   |          |              
PB3 , // |SWO                           |    |    |+SCK |     |+SCK |      |+TX   |      |     |+TIM8_CH1N +TIM2_CH2                      |   |          |*JTDO-TRACESWO
PB4 , // |                              |    |    |+MISO|     |+MISO|      |+RX   |      |     |+TIM8_CH2N +TIM3_CH1 +TIM16_CH1           |   |          |*NJTRST       
PB5 , // |                              |    |    |+MOSI|     |+MOSI|      |      |      |     |+TIM3_CH2 +TIM8_CH3N +TIM17_CH1           |   |          |              
PB6 , // |I2C1_SCL [LSM303DLHC_SCL]     |+SCL|    |     |     |     |+TX   |      |      |     |+TIM8_CH1 +TIM16_CH1N +TIM4_CH1           |   |          |              
PB7 , // |I2C1_SDA [LSM303DLHC_SDA]     |+SDA|    |     |     |     |+RX   |      |      |     |*TIM17_CH1N +TIM3_CH4 +TIM4_CH2           |   |          |              
PB8 , // |                              |+SCL|    |     |     |     |      |      |      |     |+TIM8_CH2 +TIM4_CH3 +TIM16_CH1            |   |          |              
PB9 , // |                              |+SDA|    |     |     |     |      |      |      |     |+TIM4_CH4 +TIM17_CH1 +TIM8_CH3            |   |          |              
PB10, // |                              |    |    |     |     |     |      |      |*TX   |     |+TIM2_CH3                                 |   |          |              
PB11, // |                              |    |    |     |     |     |      |      |+RX   |     |+TIM2_CH4                                 |   |          |              
PB12, // |                              |    |    |     |     |     |      |      |      |     |                                          |   |          |              
PB13, // |                              |    |    |     |+SCK |     |      |      |      |     |+TIM1_CH1N                                |   |          |              
...
PD14, // |                              |    |    |     |     |     |      |      |      |     |*TIM4_CH3                                 |   |          |              
PD15, // |                              |    |    |     |     |     |      |      |      |     |*TIM4_CH4                                 |   |          |              
PE0 , // |MEMS_INT1 [L3GD20_INT1]       |    |    |     |     |     |+TX   |      |      |     |+TIM16_CH1                                |   |          |              
PE1 , // |MEMS_INT2 [L3GD20_DRDY/INT2]  |    |    |     |     |     |+RX   |      |      |     |+TIM17_CH1                                |   |          |              
PE2 , // |DRDY [LSM303DLHC_DRDY]        |    |    |     |     |     |      |      |      |     |*TIM3_CH1                                 |   |          |*TRACECK      
PE3 , // |CS_I2C/SPI [L3GD20_CS_I2C/SPI]|    |    |     |     |     |      |      |      |     |*TIM3_CH2                                 |   |          |*TRACED0      
PE4 , // |MEMS_INT3 [LSM303DLHC_INT1]   |    |    |     |     |     |      |      |      |     |*TIM3_CH3                                 |   |          |*TRACED1      
PE5 , // |MEMS_INT4 [LSM303DLHC_INT2]   |    |    |     |     |     |      |      |      |     |*TIM3_CH4                                 |   |          |*TRACED2      
PE6 , // |                              |    |    |     |     |     |      |      |      |     |                                          |   |          |*TRACED3      
PE7 , // |                              |    |    |     |     |     |      |      |      |     |                                          |   |          |              
PE8 , // |LD4 [Blue Led]                |    |    |     |     |     |      |      |      |     |+TIM1_CH1N                                |   |          |              
PE9 , // |LD3 [Red Led]                 |    |    |     |     |     |      |      |      |     |*TIM1_CH1                                 |   |          |              
PE10, // |LD5 [Orange Led]              |    |    |     |     |     |      |      |      |     |+TIM1_CH2N                                |   |          |              
PE11, // |LD7 [Green Led]               |    |    |     |     |     |      |      |      |     |*TIM1_CH2                                 |   |          |              
PE12, // |LD9 [Blue Led]                |    |    |     |     |     |      |      |      |     |+TIM1_CH3N                                |   |          |              
PE13, // |LD10 [Red Led]                |    |    |     |     |     |      |      |      |     |*TIM1_CH3                                 |   |          |              
PE14, // |LD8 [Orange Led]              |    |    |     |     |     |      |      |      |     |*TIM1_CH4                                 |   |          |              
PE15, // |LD6 [Green Led]               |    |    |     |     |     |      |      |*RX   |     |                                          |   |          |              
PF0 , // |OSC_IN                        |    |*SDA|     |     |     |      |      |      |     |*TIM1_CH3N                                |   |*OSC_IN   |              
PF1 , // |OSC_OUT                       |    |*SCL|     |     |     |      |      |      |     |                                          |   |*OSC_OUT  |              
PF2 , // |                              |    |    |     |     |     |      |      |      |*IN10|                                          |   |          |              
PF4 , // |                              |    |    |     |     |     |      |      |      |*IN5 |                                          |   |          |              
PF6 , // |                              |    |+SCL|     |     |     |      |      |      |     |+TIM4_CH4                                 |   |          |              
PF9 , // |                              |    |    |     |*SCK |     |      |      |      |     |*TIM15_CH1                                |   |          |              
