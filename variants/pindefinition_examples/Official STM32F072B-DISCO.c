...
PA0 , // |B1 [Blue PushButton]            |    |    |     |     |      |      |      |*TX   |*TIM2_CH1                                 |   |          |      
...
PB8 , // |                                |+SCL|    |     |     |      |      |      |      |+TIM16_CH1                                |   |          |      
PB9 , // |                                |+SDA|    |     |     |      |      |      |      |+TIM17_CH1                                |   |          |      
PB10, // |I2C2_SCL[EXT/RF-E2P_SCL]        |    |*SCL|     |*SCK |      |      |+TX   |      |+TIM2_CH3                                 |   |          |      
PB11, // |I2C2_SDA[EXT/RF-E2P_SDA]        |    |*SDA|     |     |      |      |+RX   |      |+TIM2_CH4                                 |   |          |      
PB12, // |                                |    |    |     |     |      |      |      |      |                                          |   |          |      
PB13, // |SPI2_SCK [L3GD20_SCL/SPC]       |    |+SCL|     |+SCK |      |      |      |      |+TIM1_CH1N                                |   |          |      
PB14, // |SPI2_MISO [L3GD20_SDO]          |    |+SDA|     |+MISO|      |      |      |      |+TIM1_CH2N +TIM15_CH1                     |   |          |      
PB15, // |SPI2_MOSI [L3GD20_SDA/SDI]      |    |    |     |+MOSI|      |      |      |      |+TIM1_CH3N +TIM15_CH1N +TIM15_CH2         |   |          |      
PC0 , // |NCS_MEMS_SPI [L3GD20_CS_I2C/SPI]|    |    |     |     |      |      |      |      |                                          |   |          |      
PC1 , // |MEMS_INT1 [L3GD20_INT1]         |    |    |     |     |      |      |      |      |                                          |   |          |      
PC2 , // |MEMS_INT2 [L3GD20_INT2]         |    |    |     |*MISO|      |      |      |      |                                          |   |          |      
PC3 , // |                                |    |    |     |*MOSI|      |      |      |      |                                          |   |          |      
PC4 , // |                                |    |    |     |     |      |      |*TX   |      |                                          |   |          |      
PC5 , // |EXT_RESET [EXT/RF-E2P_EXT_RESET]|    |    |     |     |      |      |*RX   |      |                                          |   |          |      
PC6 , // |LD3 [Red Led]                   |    |    |     |     |      |      |      |      |+TIM3_CH1                                 |   |          |      
PC7 , // |LD6 [Blue Led]                  |    |    |     |     |      |      |      |      |+TIM3_CH2                                 |   |          |      
PC8 , // |LD4 [Orange Led]                |    |    |     |     |      |      |      |      |+TIM3_CH3                                 |   |          |      
PC9 , // |LD5 [GReen Led]                 |    |    |     |     |      |      |      |      |+TIM3_CH4                                 |   |          |      
PC10, // |                                |    |    |     |     |      |      |+TX   |+TX   |                                          |   |          |      
PC11, // |                                |    |    |     |     |      |      |+RX   |+RX   |                                          |   |          |      
PC12, // |                                |    |    |     |     |      |      |      |      |                                          |   |          |      
PC13, // |                                |    |    |     |     |      |      |      |      |                                          |   |          |      
