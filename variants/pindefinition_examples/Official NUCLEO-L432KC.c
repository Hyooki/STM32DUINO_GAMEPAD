...
enum {
//*=default , +=alternate
//PIN    |BOARD LABEL              |I2C1|I2C3|SPI1 |SPI3 |USART1|USART2|ADC1 |TIM (PWM)             |USB|RCC       |SYS        
PA0 , // |MCO [High speed clock in]|    |    |     |     |      |      |*IN5 |*TIM2_CH1             |   |*CK_IN    |           
PA1 , // |                         |    |    |*SCK |     |      |      |*IN6 |*TIM15_CH1N *TIM2_CH2 |   |          |           
PA2 , // |VCP_TX                   |    |    |     |     |      |*TX   |*IN7 |*TIM2_CH3 *TIM15_CH1  |   |          |           
PA3 , // |                         |    |    |     |     |      |*RX   |*IN8 |*TIM15_CH2 *TIM2_CH4  |   |          |           
PA4 , // |                         |    |    |     |     |      |      |*IN9 |                      |   |          |           
PA5 , // |                         |    |    |+SCK |     |      |      |*IN10|+TIM2_CH1             |   |          |           
PA6 , // |                         |    |    |*MISO|     |      |      |*IN11|*TIM16_CH1            |   |          |           
PA7 , // |                         |    |*SCL|*MOSI|     |      |      |*IN12|*TIM1_CH1N            |   |          |           
PA8 , // |                         |    |    |     |     |      |      |     |*TIM1_CH1             |   |          |           
PA9 , // |                         |*SCL|    |     |     |*TX   |      |     |*TIM1_CH2             |   |          |           
PA10, // |                         |*SDA|    |     |     |*RX   |      |     |*TIM1_CH3             |   |          |           
PA11, // |                         |    |    |+MISO|     |      |      |     |*TIM1_CH4             |*DM|          |           
PA12, // |                         |    |    |+MOSI|     |      |      |     |                      |*DP|          |           
PA13, // |SWDIO                    |    |    |     |     |      |      |     |                      |   |          |*JTMS-SWDIO
PA14, // |SWCLK                    |    |    |     |     |      |      |     |                      |   |          |*JTCK-SWCLK
PA15, // |VCP_RX                   |    |    |     |     |      |+RX   |     |+TIM2_CH1             |   |          |*JTDI      
PB0 , // |                         |    |    |     |     |      |      |*IN15|*TIM1_CH2N            |   |          |           
PB1 , // |                         |    |    |     |     |      |      |*IN16|*LPTIM2_IN1 *TIM1_CH3N|   |          |           
PB3 , // |LD3 [Green]              |    |    |+SCK |*SCK |      |      |     |+TIM2_CH2             |   |          |*JTDO-SWO  
PB4 , // |                         |    |*SDA|+MISO|*MISO|      |      |     |                      |   |          |*JTRST     
PB5 , // |                         |    |    |+MOSI|*MOSI|      |      |     |*LPTIM1_IN1           |   |          |           
...
remaps_t remaps {
    ...
    { I2C3  , SCL  , GPIOA, GPIO_PIN_7  , GPIO_AF4_I2C3                      },
    ...
    { SPI1  , SCK  , GPIOA, GPIO_PIN_1  , GPIO_AF5_SPI1                      },
    ...
    { USART2, RX   , GPIOA, GPIO_PIN_15 , GPIO_AF3_USART2                    },
