...
enum {
//*=default , +=alternate
//PIN    |BOARD LABEL                   |I2C1|I2C2|I2C3|SPI1 |SPI2 |SPI3 |SPI4 |USART1|USART2|USART6|ADC1 |TIM (PWM)                    |USB       |SDIO|RCC       |SYS        
PA0 , // |B1 [Blue PushButton]          |    |    |    |     |     |     |     |      |      |      |*IN0 |*TIM5_CH1 *TIM2_CH1          |          |    |          |           
PA1 , // |                              |    |    |    |     |     |     |     |      |      |      |*IN1 |*TIM5_CH2 *TIM2_CH2          |          |    |          |           
...
PA6 , // |SPI1_MISO [L3GD20_AS0/SDO]    |    |    |    |*MISO|     |     |     |      |      |      |*IN6 |*TIM3_CH1                    |          |    |          |           
PA7 , // |SPI1_MISO [L3GD20_SDA/SDI/SDO]|    |    |    |*MOSI|     |     |     |      |      |      |*IN7 |*TIM1_CH1N *TIM3_CH2         |          |    |          |           
PA8 , // |                              |    |    |*SCL|     |     |     |     |      |      |      |     |+TIM1_CH1                    |          |    |          |           
PA9 , // |VBUS_FS                       |    |    |    |     |     |     |     |*TX   |      |      |     |+TIM1_CH2                    |          |    |          |           
PA10, // |OTG_FS_ID                     |    |    |    |     |     |     |     |*RX   |      |      |     |+TIM1_CH3                    |          |    |          |           
PA11, // |OTG_FS_DM                     |    |    |    |     |     |     |     |      |      |+TX   |     |+TIM1_CH4                    |*OTG_FS_DM|    |          |           
PA12, // |OTG_FS_DP                     |    |    |    |     |     |     |     |      |      |+RX   |     |                             |*OTG_FS_DP|    |          |           
...
PB2 , // |                              |    |    |    |     |     |     |     |      |      |      |     |                             |          |    |          |           
PB3 , // |SWO                           |    |*SDA|    |+SCK |     |+SCK |     |      |      |      |     |+TIM2_CH2                    |          |    |          |*JTDO-SWO  
PB4 , // |                              |    |    |+SDA|+MISO|     |+MISO|     |      |      |      |     |+TIM3_CH1                    |          |    |          |*JTRST     
PB5 , // |                              |    |    |    |+MOSI|     |+MOSI|     |      |      |      |     |+TIM3_CH2                    |          |    |          |           
PB6 , // |Audio_SCL [CS43L22_SCL]       |*SCL|    |    |     |     |     |     |+TX   |      |      |     |+TIM4_CH1                    |          |    |          |           
PB7 , // |                              |*SDA|    |    |     |     |     |     |+RX   |      |      |     |+TIM4_CH2                    |          |    |          |           
PB8 , // |                              |+SCL|    |    |     |     |     |     |      |      |      |     |*TIM10_CH1 +TIM4_CH3         |          |*D4 |          |           
PB9 , // |Audio_SDA [CS43L22_SDA]       |+SDA|    |    |     |     |     |     |      |      |      |     |+TIM4_CH4 *TIM11_CH1         |          |*D5 |          |           
PB10, // |CLK_IN [MP45DT02_CLK]         |    |*SCL|    |     |*SCK |     |     |      |      |      |     |+TIM2_CH3                    |          |    |          |           
PB12, // |                              |    |    |    |     |     |     |     |      |      |      |     |                             |          |    |          |           
PB13, // |                              |    |    |    |     |+SCK |     |     |      |      |      |     |+TIM1_CH1N                   |          |    |          |           
PB14, // |                              |    |    |    |     |+MISO|     |     |      |      |      |     |+TIM1_CH2N                   |          |    |          |           
PB15, // |                              |    |    |    |     |+MOSI|     |     |      |      |      |     |+TIM1_CH3N                   |          |    |          |           
...
PC5 , // |                              |    |    |    |     |     |     |     |      |      |      |*IN15|                             |          |    |          |           
PC6 , // |                              |    |    |    |     |     |     |     |      |      |*TX   |     |+TIM3_CH1                    |          |*D6 |          |           
PC7 , // |I2S3_MCK [CS43L22_MCLK]       |    |    |    |     |     |     |     |      |      |*RX   |     |+TIM3_CH2                    |          |*D7 |          |           
PC8 , // |                              |    |    |    |     |     |     |     |      |      |      |     |+TIM3_CH3                    |          |*D0 |          |           
PC9 , // |                              |    |    |*SDA|     |     |     |     |      |      |      |     |+TIM3_CH4                    |          |*D1 |          |           
