...
#define MAX_DIGITAL_IOS               NB_DIGITAL_PINS // All pins can be used as digital pins
...
static const uint8_t MOSI = PA7;
static const uint8_t MISO = PA6;
static const uint8_t SCK  = PA5;
